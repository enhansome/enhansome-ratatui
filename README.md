...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,504 | 🐛 208 | 🌐 Rust | 📅 2026-09-04
...
* [termprofile](https://github.com/aschey/termprofile) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - Detect and handle terminal color/styling support. Supports converting Ratatui color and style objects.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 113 | 🐛 0 | 🌐 Elixir | 📅 2026-09-04 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,950 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,464 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,867 | 🐛 290 | 🌐 Rust | 📅 2026-09-04 - Comprehensive Deep Learning framework in Rust.
...
* [serie](https://github.com/lusingander/serie) ⭐ 2,082 | 🐛 24 | 🌐 Rust | 📅 2026-09-05 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,074 | 🐛 149 | 🌐 Rust | 📅 2026-09-05 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,769 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 923 | 🐛 10 | 🌐 Rust | 📅 2026-09-05 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 832 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 525 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 469 | 🐛 10 | 🌐 Rust | 📅 2026-09-04 - Live pixel-art office for AI coding agents.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 437 | 🐛 26 | 🌐 Rust | 📅 2026-09-05 - Tracer for execve{,at} and pre-exec behavior, launcher for debuggers.
* [Yozefu](https://github.com/MAIF/yozefu/) ⭐ 344 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - A TUI for exploring data of a Kafka cluster.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 294 | 🐛 5 | 🌐 Rust | 📅 2026-09-05 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 279 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 69 | 🐛 2 | 🌐 Rust | 📅 2026-09-05 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 60 | 🐛 1 | 🌐 Rust | 📅 2026-09-05 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 40 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 20 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [Proqi](https://github.com/oborchers/proqi) ⭐ 20 | 🐛 4 | 🌐 Rust | 📅 2026-09-05 - A terminal-native prompt composer for developers working with coding agents.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-09-05 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 12 | 🌐 Rust | 📅 2026-09-04 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,166 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Terminal-based Chess game.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,177 | 🐛 177 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,368 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,307 | 🐛 30 | 🌐 Rust | 📅 2026-09-04 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,124 | 🐛 45 | 📅 2026-08-30 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 90,097 | 🐛 1,107 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,511 | 🐛 2,509 | 🌐 Rust | 📅 2026-09-05 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,669 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,951 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,527 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,853 | 🐛 79 | 🌐 Rust | 📅 2026-09-04 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,992 | 🐛 18 | 🌐 Rust | 📅 2026-09-04 - A cross-platform network monitoring tool with deep packet inspection.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,833 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,139 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 648 | 🐛 24 | 🌐 Rust | 📅 2026-09-02 - Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 85 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

### 🚀 Productivity and Utilities

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,537 | 🐛 430 | 🌐 Rust | 📅 2026-09-05 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,245 | 🐛 80 | 🌐 Rust | 📅 2026-09-04 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,248 | 🐛 18 | 🌐 Shell | 📅 2026-09-01 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,493 | 🐛 125 | 🌐 Rust | 📅 2026-09-04 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,416 | 🐛 39 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,954 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,710 | 🐛 68 | 🌐 Rust | 📅 2026-09-03 - Run multiple commands in parallel and shows output of each command separately.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,096 | 🐛 32 | 🌐 Rust | 📅 2026-09-01 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 986 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-05 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 416 | 🐛 11 | 🌐 Rust | 📅 2026-09-05 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 293 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 268 | 🐛 8 | 🌐 Rust | 📅 2026-09-03 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 237 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 - Fuzzy picker (FZF reboot).
...
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 11 | 🌐 Rust | 📅 2026-09-05 - A TUI feed viewer.
...
* [termi](https://github.com/tuna4ll/termi) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A modal terminal code editor.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 2 | 🐛 11 | 🌐 Rust | 📅 2026-09-02 - A Terminal Markdown editor that stays rendered while you edit.
* [ratslate](https://github.com/azihsoyn/ratslate) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - An infinite-canvas whiteboard driven by the mouse.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,388 | 🐛 40 | 🌐 Rust | 📅 2026-09-04 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,275 | 🐛 156 | 🌐 Rust | 📅 2026-09-05 - A matrix chat client with vim keybindings.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,976 | 🐛 107 | 🌐 Rust | 📅 2026-09-05 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,225 | 🐛 0 | 🌐 Rust | 📅 2026-09-05 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,295 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,866 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,557 | 🐛 20 | 🌐 Rust | 📅 2026-09-04 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 924 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - A terminal app for managing Docker containers, inspired by K9s.
...
* [purple](https://github.com/erickochen/purple) ⭐ 672 | 🐛 6 | 🌐 Rust | 📅 2026-09-03 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-05 - A minimal serial monitor with plotter TUI.
