...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,347 | 🐛 217 | 🌐 Rust | 📅 2026-08-23
...
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,315 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - An embedded-graphics backend for Ratatui.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 88 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [tachyonfx](https://github.com/junkdog/tachyonfx) ⭐ 1,288 | 🐛 7 | 🌐 Rust | 📅 2026-07-19 - A shader-like effects library for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,629 | 🐛 65 | 🌐 Rust | 📅 2026-08-23 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,423 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,806 | 🐛 302 | 🌐 Rust | 📅 2026-08-21 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,702 | 🐛 19 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,317 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,301 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,885 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,051 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,810 | 🐛 112 | 🌐 Rust | 📅 2026-08-24 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,747 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,374 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,306 | 🐛 10 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,193 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 908 | 🐛 15 | 🌐 Rust | 📅 2026-08-23 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 818 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 523 | 🐛 4 | 🌐 Rust | 📅 2026-08-21 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 452 | 🐛 11 | 🌐 Rust | 📅 2026-08-23 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 255 | 🐛 7 | 🌐 Rust | 📅 2026-08-24 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [tongo](https://github.com/drewzemke/tongo) ⭐ 71 | 🐛 2 | 🌐 Rust | 📅 2026-08-23 - A TUI for MongoDB.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 55 | 🐛 5 | 🌐 Rust | 📅 2026-08-24 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [gimoji](https://github.com/zeenix/gimoji) ⭐ 52 | 🐛 6 | 🌐 Rust | 📅 2026-08-23 - Makes it easy to add emojis to your Git commit messages.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 48 | 🐛 2 | 🌐 Rust | 📅 2026-08-23 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 42 | 🐛 1 | 🌐 Rust | 📅 2026-08-23 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 9 | 🌐 Rust | 📅 2026-08-22 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 6 | 🐛 8 | 🌐 Rust | 📅 2026-08-24 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 2 | 🐛 6 | 🌐 Rust | 📅 2026-08-23 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,158 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Terminal-based Chess game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,316 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,110 | 🐛 165 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,297 | 🐛 9 | 🌐 Rust | 📅 2026-08-21 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,252 | 🐛 27 | 🌐 Rust | 📅 2026-08-22 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,102 | 🐛 48 | 🌐 Rust | 📅 2026-08-08 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 202 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [ytsub](https://github.com/sarowish/ytsub) ⭐ 89 | 🐛 2 | 🌐 Rust | 📅 2026-08-23 - A subscriptions only TUI YouTube client.
...
* [TRNovel](https://github.com/yexiyue/TRNovel) ⭐ 62 | 🐛 3 | 🌐 Rust | 📅 2026-08-02 - A terminal novel reader for local and network novels, with AI-assisted book-source generation and TTS playback.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,157 | 🐛 1,089 | 🌐 Dart | 📅 2026-08-24
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,440 | 🐛 2,525 | 🌐 Rust | 📅 2026-08-22 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,637 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,915 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,501 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,517 | 🐛 77 | 🌐 Rust | 📅 2026-08-24 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,902 | 🐛 17 | 🌐 Rust | 📅 2026-08-23 - A cross-platform network monitoring tool with deep packet inspection.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,793 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi on Linux.
...
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,638 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,095 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 242 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,389 | 🐛 408 | 🌐 Rust | 📅 2026-08-22 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,201 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,229 | 🐛 12 | 🌐 Shell | 📅 2026-08-17 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,481 | 🐛 123 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,398 | 🐛 35 | 🌐 Rust | 📅 2026-08-23 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,938 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,969 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 - A TUI for managing Bluetooth devices.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,109 | 🐛 132 | 🌐 Rust | 📅 2026-08-23 - TUI for the Taskwarrior command-line task manager.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,075 | 🐛 24 | 🌐 Rust | 📅 2026-08-19 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [models](https://github.com/arimxyer/models) ⭐ 494 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 410 | 🐛 7 | 🌐 Rust | 📅 2026-08-21 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 288 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 75 | 🐛 9 | 🌐 Rust | 📅 2026-08-23 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 24 | 🐛 1 | 🌐 Rust | 📅 2026-08-12 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,267 | 🐛 166 | 🌐 Rust | 📅 2026-08-23 - A matrix chat client with vim keybindings.
* [concord](https://github.com/chojs23/concord) ⭐ 1,258 | 🐛 38 | 🌐 Rust | 📅 2026-08-21 - A TUI client for Discord.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,165 | 🐛 36 | 🌐 Rust | 📅 2026-08-16 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,809 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - Hackable, minimal, and fast TUI file explorer.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,043 | 🐛 42 | 🌐 Rust | 📅 2026-08-24 - Cross-platform monitoring tool for system stats.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,225 | 🐛 51 | 🌐 Rust | 📅 2026-08-24 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,825 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,816 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 718 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 648 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 104 | 🐛 7 | 🌐 Rust | 📅 2026-08-23 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
* [b4n](https://github.com/fioletoven/b4n) ⭐ 103 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - A terminal-based tool for browsing Kubernetes resources.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,742 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
...
* [hncli](https://github.com/pierreyoda/hncli) ⭐ 50 | 🐛 2 | 🌐 Rust | 📅 2026-08-17 - Hacker News read-only TUI.
