...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,356 | 🐛 218 | 🌐 Rust | 📅 2026-08-23
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 112 | 🐛 1 | 🌐 Elixir | 📅 2026-08-24 - Elixir bindings for ratatui.
...
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,427 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,807 | 🐛 296 | 🌐 Rust | 📅 2026-08-24 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,703 | 🐛 19 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,887 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,051 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,811 | 🐛 122 | 🌐 Rust | 📅 2026-08-24 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,748 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,194 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 909 | 🐛 7 | 🌐 Rust | 📅 2026-08-24 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 820 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 523 | 🐛 9 | 🌐 Rust | 📅 2026-08-24 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 452 | 🐛 11 | 🌐 Rust | 📅 2026-08-24 - Live pixel-art office for AI coding agents.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 437 | 🐛 26 | 🌐 Rust | 📅 2026-08-24 - Tracer for execve{,at} and pre-exec behavior, launcher for debuggers.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 255 | 🐛 9 | 🌐 Rust | 📅 2026-08-24 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 208 | 🐛 0 | 🌐 Rust | 📅 2026-08-21 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 15 | 🌐 Rust | 📅 2026-08-24 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 57 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
* [ygrep](https://github.com/yetidevworks/ygrep) ⭐ 56 | 🐛 1 | 🌐 Rust | 📅 2026-07-30 - A fast, local, indexed code search tool with a TUI, optimized for AI coding assistants and powered by Tantivy full-text indexing.
* [gimoji](https://github.com/zeenix/gimoji) ⭐ 52 | 🐛 6 | 🌐 Rust | 📅 2026-08-23 - Makes it easy to add emojis to your Git commit messages.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 48 | 🐛 2 | 🌐 Rust | 📅 2026-08-24 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 42 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 11 | 🐛 1 | 🌐 Rust | 📅 2026-08-23 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 9 | 🌐 Rust | 📅 2026-08-24 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 6 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,114 | 🐛 165 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,296 | 🐛 9 | 🌐 Rust | 📅 2026-08-21 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,255 | 🐛 27 | 🌐 Rust | 📅 2026-08-22 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 204 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [TRNovel](https://github.com/yexiyue/TRNovel) ⭐ 62 | 🐛 2 | 🌐 Rust | 📅 2026-08-24 - A terminal novel reader for local and network novels, with AI-assisted book-source generation and TTS playback.
...
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 46 | 🐛 3 | 🌐 Rust | 📅 2026-08-17 - Deezer music TUI with included background player.
...
* [audium](https://github.com/takashialpha/audium) ⭐ 36 | 🐛 1 | 🌐 Rust | 📅 2026-08-20 - A keyboard-driven music app for people who live in the terminal.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,224 | 🐛 1,089 | 🌐 Dart | 📅 2026-08-24
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,446 | 🐛 2,528 | 🌐 Rust | 📅 2026-08-24 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,638 | 🐛 52 | 🌐 Rust | 📅 2026-08-24 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,917 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,502 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,520 | 🐛 77 | 🌐 Rust | 📅 2026-08-24 - Network diagnostic tool.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,055 | 🐛 7 | 🌐 Rust | 📅 2026-07-29 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,793 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,563 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,813 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,640 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,098 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 244 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [ytunnel](https://github.com/yetidevworks/ytunnel) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - A TUI-first CLI for managing Cloudflare Tunnels with custom domains.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,394 | 🐛 410 | 🌐 Rust | 📅 2026-08-22 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,204 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [xan](https://github.com/medialab/xan) ⭐ 4,481 | 🐛 122 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,399 | 🐛 35 | 🌐 Rust | 📅 2026-08-23 - A TUI for analyzing binary files.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,699 | 🐛 67 | 🌐 Rust | 📅 2026-08-24 - Run multiple commands in parallel and shows output of each command separately.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,075 | 🐛 25 | 🌐 Rust | 📅 2026-08-24 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 940 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [models](https://github.com/arimxyer/models) ⭐ 495 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 426 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,262 | 🐛 38 | 🌐 Rust | 📅 2026-08-24 - A TUI client for Discord.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,171 | 🐛 35 | 🌐 Rust | 📅 2026-08-24 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,234 | 🐛 51 | 🌐 Rust | 📅 2026-08-24 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,826 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,817 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,553 | 🐛 19 | 🌐 Rust | 📅 2026-08-23 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 720 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 653 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 61 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 168 | 🐛 6 | 🌐 Rust | 📅 2026-08-24 - A minimal serial monitor with plotter TUI.
...
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,348 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,070 | 🐛 10 | 🌐 Rust | 📅 2026-08-10 - Alternative watch command with command history and diffs.
...
* [theattyr](https://github.com/orhun/theattyr) ⭐ 169 | 🐛 1 | 🌐 Rust | 📅 2024-10-26 - A terminal theater for playing VT100 art and animations.
