...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,686 | 🐛 207 | 🌐 Rust | 📅 2026-09-20
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,959 | 🐛 329 | 🌐 Rust | 📅 2026-09-19 - Comprehensive Deep Learning framework in Rust.
* [ratzilla](https://github.com/ratatui/ratzilla) ⭐ 1,454 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/ratatui/mousefood) ⭐ 1,329 | 🐛 22 | 🌐 Rust | 📅 2026-09-15 - An embedded-graphics backend for Ratatui.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 92 | 🐛 11 | 🌐 Rust | 📅 2026-09-21 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [ratatui-kit](https://github.com/yexiyue/ratatui-kit) ⭐ 49 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A React-style component framework for Ratatui with hooks, routing, async state, input layers, and reusable components.
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-17 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 46 | 🐛 9 | 🌐 Rust | 📅 2026-09-20 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [ratatui-form](https://github.com/DavidLiedle/ratatui-form) ⭐ 20 | 🐛 3 | 🌐 Rust | 📅 2026-04-13 - A form library.
...
* [pyratatui](https://github.com/programmersd21/pyratatui) ⭐ 163 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - Python bindings for Ratatui powered by PyO3, featuring async support, many widgets, and advanced terminal animations via TachyonFX.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 117 | 🐛 1 | 🌐 Elixir | 📅 2026-09-20 - Elixir bindings for ratatui.
* [ratatui-ffi](https://github.com/holo-q/ratatui-ffi) ⭐ 54 | 🐛 2 | 🌐 Rust | 📅 2026-06-04 - Foreign Function Interface bindings for Ratatui.
* [ratatui-py](https://github.com/holo-q/ratatui-py) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-06-04 - Python bindings for ratatui.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,510 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,319 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,917 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,108 | 🐛 25 | 🌐 Rust | 📅 2026-09-21 - A rich Git commit graph in your terminal.
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,213 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - A TUI for the Jujutsu version-control system.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 136 | 🐛 17 | 🌐 Rust | 📅 2026-09-21 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 3 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - Real-time terminal file diff monitoring TUI.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 535 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
...
* [rgx](https://github.com/brevity1swos/rgx) ⭐ 238 | 🐛 0 | 🌐 Rust | 📅 2026-07-07 - A terminal regex debugger with real-time matching, 3 engines, capture group highlighting, replace mode, and plain-English explanations.
...
* [lingora-tui](https://github.com/nigeleke/lingora) ⭐ 35 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - Browse, compare and validate Fluent i18n files.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,552 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - An HTTP load generator with a real-time terminal UI.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,343 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management TUI for Postgres.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,728 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,320 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,415 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 602 | 🐛 55 | 🌐 Rust | 📅 2026-09-18 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 438 | 🐛 26 | 🌐 Rust | 📅 2026-09-19 - A terminal tool for tracing which programs and commands are executed.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,304 | 🐛 62 | 🌐 Rust | 📅 2026-09-21 - An open-source desktop workspace for general-purpose AI agents.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,793 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 940 | 🐛 15 | 🌐 Rust | 📅 2026-09-21 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 851 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - An open-source Rust coding agent for the terminal.
...
* [patent](https://github.com/r14dd/patent) ⭐ 527 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - A prior-art search for developer-tool ideas with an AI-generated verdict.
* [models](https://github.com/reyamira/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 481 | 🐛 8 | 🌐 Rust | 📅 2026-09-21 - Live pixel-art office for AI coding agents.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 236 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A local proxy that compresses large-language-model API requests to reduce token costs, with a dashboard for per-source costs and context usage.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 76 | 🐛 6 | 🌐 Rust | 📅 2026-09-20 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 72 | 🐛 11 | 🌐 Rust | 📅 2026-09-21 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 35 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - A terminal-native prompt composer for developers working with coding agents.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 22 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - A local dashboard for Codex and Claude Code.
...
* [hedos](https://github.com/theiskaa/hedos) ⭐ 14 | 🐛 7 | 🌐 Rust | 📅 2026-09-20 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 2 | 🌐 Rust | 📅 2026-09-21 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [savras](https://github.com/Marijusaj/savras) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - A side panel that sees every Claude Code session you have running: which are waiting on you, working, or done, with their PRs and context used.
* [lumen](https://github.com/blackopsrepl/lumen) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - Runs a ratatui app as an agent session and gives a human a live cell-grid view of it.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,828 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,518 | 🐛 122 | 🌐 Rust | 📅 2026-09-18 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,434 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,976 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,759 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,731 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - Ranger-like terminal file manager written in Rust.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,131 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,116 | 🐛 17 | 🌐 Rust | 📅 2026-09-20 - A lightweight TUI app to view and query CSV files.
* [stu](https://github.com/lusingander/stu) ⭐ 910 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - A TUI for AWS S3.
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 551 | 🐛 25 | 🌐 Rust | 📅 2026-09-18 - Markdown renderer in the terminal.
...
* [hexhog](https://github.com/DVDTSB/hexhog) ⭐ 279 | 🐛 8 | 🌐 Rust | 📅 2026-02-16 - TUI Hex Editor/Viewer.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 96 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 4 | 🐛 19 | 🌐 Rust | 📅 2026-09-19 - A Terminal Markdown editor that stays rendered while you edit.

### 🧰 Terminal Workflow

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,772 | 🐛 420 | 🌐 Rust | 📅 2026-09-21 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,280 | 🐛 78 | 🌐 Rust | 📅 2026-09-19 - A blazingly fast general purpose fuzzy finder for your terminal.
* [dekit](https://github.com/pvolok/dekit) ⭐ 2,725 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Run multiple commands in parallel and shows output of each command separately.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,290 | 🐛 31 | 🌐 Rust | 📅 2026-09-20 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 428 | 🐛 10 | 🌐 Rust | 📅 2026-09-18 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 392 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 301 | 🐛 47 | 🌐 Rust | 📅 2026-09-16 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 215 | 🐛 13 | 🌐 Rust | 📅 2026-09-20 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,686 | 🐛 41 | 🌐 Rust | 📅 2026-09-18 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,981 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,946 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,041 | 🐛 30 | 🌐 Rust | 📅 2026-09-21 - A cross-platform network monitoring tool with deep packet inspection.
* [impala](https://github.com/pythops/impala) ⭐ 2,856 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,579 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,855 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,660 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,187 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 731 | 🐛 13 | 🌐 Rust | 📅 2026-08-09 - A terminal client for subscribing to and publishing messages over MQTT.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 258 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 113 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - A terminal monitor for live video streams with real-time health checks and metrics.
...
* [FlowLens](https://github.com/power4j/flowlens) ⭐ 11 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A cross-platform network traffic analyzer with process, IP, and outbound-domain attribution.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 92,289 | 🐛 1,131 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,094 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [slumber](https://github.com/LucasPickering/slumber) ⭐ 1,227 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - Terminal-based HTTP/REST client.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 699 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa.si tui tool for browsing and downloading torrents.
* [purple](https://github.com/erickochen/purple) ⭐ 699 | 🐛 6 | 🌐 Rust | 📅 2026-09-21 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,540 | 🐛 44 | 🌐 Rust | 📅 2026-09-19 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,287 | 🐛 110 | 🌐 Rust | 📅 2026-09-21 - A matrix chat client with vim keybindings.
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,014 | 🐛 17 | 🌐 Rust | 📅 2026-09-21 - A TUI for Telegram written in Rust.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 73 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [tincan](https://github.com/bilalyazicioglu/tincan-cli) ⭐ 9 | 🐛 49 | 🌐 Rust | 📅 2026-09-20 - Peer-to-peer voice and text chat with no server.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,594 | 🐛 2,488 | 🌐 Rust | 📅 2026-09-18 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,039 | 🐛 106 | 🌐 Rust | 📅 2026-09-18 - Cross-platform graphical process/system monitor.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,054 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Cross-platform monitoring tool for system stats.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 462 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 118 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,538 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A simple and fast dashboard for Kubernetes.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,850 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,564 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 395 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - TUI for real-time monitoring of Kubernetes resources.
* [b4n](https://github.com/fioletoven/b4n) ⭐ 106 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A terminal-based tool for browsing Kubernetes resources.
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 90 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,287 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,291 | 🐛 20 | 🌐 Shell | 📅 2026-09-14 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,335 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) ⭐ 1,582 | 🐛 6 | 🌐 Rust | 📅 2026-09-13 - A program for managing systemd services through a TUI.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 865 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [mirro-rs](https://github.com/rtkay123/mirro-rs) ⭐ 117 | 🐛 24 | 🌐 Rust | 📅 2026-09-16 - An Arch Linux mirrorlist manager with a TUI.
...
* [dfdisk](https://github.com/tylerstyle/dfdisk) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - Modern forensic disk imaging, damaged media rescue and evidence management.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,890 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 356 | 🐛 13 | 🌐 Rust | 📅 2026-09-20 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A minimal serial monitor with plotter TUI.
...
* [quokka](https://github.com/dutradotdev/quokka) ⭐ 105 | 🐛 2 | 🌐 Rust | 📅 2026-07-27 - A TUI to inspect and tidy a USB-connected iPhone from macOS: storage, apps, media, syslog viewer.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - A terminal client for Modbus industrial devices.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,763 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 - A TUI for managing GnuPG encryption keys.
...
* [cotp](https://github.com/replydev/cotp) ⭐ 386 | 🐛 7 | 🌐 Rust | 📅 2026-09-18 - An encrypted command-line authenticator for time- and counter-based one-time passwords.
* [jwt-ui](https://github.com/jwt-rs/jwt-ui) ⭐ 351 | 🐛 10 | 🌐 Rust | 📅 2026-05-31 - A command line UI for decoding/encoding JSON Web Tokens.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 134 | 🌐 Rust | 📅 2026-09-20 - TUI for the Taskwarrior command-line task manager.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,689 | 🐛 74 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven terminal UI for todo.txt.
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 312 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [kanban](https://github.com/kanban-rs/kanban) ⭐ 169 | 🐛 12 | 🌐 Rust | 📅 2026-09-21 - TUI kanban board for projects management with sprint tracking and task prioritization.
* [Jirust](https://github.com/Code-Militia/jirust) ⭐ 160 | 🐛 6 | 🌐 Rust | 📅 2024-05-29 - A Jira TUI.
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 142 | 🐛 18 | 🌐 Rust | 📅 2026-09-21 - A terminal task manager that aggregates tasks from multiple providers.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 782 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Journaling/Notes-taking terminal-based app.
...
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,696 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 334 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [timr-tui](https://github.com/sectore/timr-tui) ⭐ 377 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - TUI to organize your time: Pomodoro, Countdown, Timer, Event.
...
* [sprout](https://github.com/kb019/sprout) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A terminal habit tracker with GitHub-style activity heatmap, streak tracking and goal management.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,010 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 432 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 296 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 11 | 🌐 Rust | 📅 2026-09-20 - A TUI feed viewer.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 92 | 🐛 9 | 🌐 Rust | 📅 2026-09-20 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [fastcards](https://github.com/indium114/fastcards) ⭐ 10 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - A CLI spaced-repetition flashcard study tool.
* [rsstig](https://github.com/indium114/rsstig) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - An unconventional terminal RSS/Atom reader.

### 🎵 Music and Media

#### Music and Audio

* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,352 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,228 | 🐛 155 | 🌐 Rust | 📅 2026-09-19 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,371 | 🐛 34 | 🌐 Rust | 📅 2026-09-19 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 378 | 🐛 4 | 🌐 Rust | 📅 2026-09-16 - A lightweight, customizable TUI music player for local files.
* [asak](https://github.com/chaosprint/asak) ⭐ 371 | 🐛 11 | 🌐 Rust | 📅 2026-04-11 - A cross-platform audio recording/playback CLI tool.
* [fum](https://github.com/qxb3/fum) ⭐ 283 | 🐛 6 | 🌐 Rust | 📅 2026-07-11 - A fully ricable tui-based music client.
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 235 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [rs-pug](https://github.com/JustRoccat/rs-pug) ⭐ 70 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A Neovim-inspired asynchronous music player with a reactive audio visualizer.
* [roon-tui](https://github.com/TheAppgineer/roon-tui) ⭐ 63 | 🐛 5 | 🌐 Rust | 📅 2024-08-30 - Roon Remote for the terminal.
* [sparkplayer](https://github.com/dividebysandwich/sparkplayer/tree/main) ⭐ 53 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A fun terminal based media player with album art and video support.
* [O₂](https://github.com/coignard/o2) ⭐ 50 | 🐛 1 | 🌐 Rust | 📅 2026-08-12 - Rust port of the ORCΛ esoteric programming language and terminal livecoding environment.
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 49 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - Deezer music TUI with included background player.
...
* [trollstov](https://github.com/hikikones/trollstov) ⭐ 37 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - A music player for the terminal where your files and their metadata are all you need.
...
* [Youta](https://github.com/vitaly-zdanevich/youta) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - An audio player for YouTube, Yandex Music, podcasts, audiobooks, radio, and local files.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,152 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,154 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 772 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
* [mal-cli](https://github.com/L4z3x/mal-cli) ⭐ 161 | 🐛 0 | 🌐 Rust | 📅 2025-07-17 - A terminal client for MyAnimeList.
...
* [TRNovel](https://github.com/yexiyue/TRNovel) ⭐ 68 | 🐛 2 | 🌐 Rust | 📅 2026-08-24 - A terminal novel reader for local and network novels, with AI-assisted book-source generation and TTS playback.
* [visualvault](https://github.com/mikeleppane/visualvault) ⭐ 66 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - A TUI for organizing media files.
* [Absotui](https://github.com/pdwaldrop/absotui) ⭐ 21 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - A fast, keyboard-driven TUI client for Audiobookshelf (self-hosted audiobook/podcast server).
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,992 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A TUI screensaver that visualizes Git commit history in your terminal.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,180 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - Terminal-based Chess game.
...
* [Inertia](https://github.com/aclfe/inertia) ⭐ 117 | 🐛 1 | 🌐 Rust | 📅 2026-07-19 - A 3D physics simulator in your terminal.
...
* [confetty\_rs](https://github.com/Handfish/confetty_rs) ⭐ 89 | 🐛 2 | 🌐 Rust | 📅 2024-02-08 - Particle system (fireworks, stars) rendered in the terminal.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - A simple idle farming game.
