...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,490 | 🐛 208 | 🌐 Rust | 📅 2026-09-04
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,439 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,323 | 🐛 22 | 🌐 Rust | 📅 2026-09-01 - An embedded-graphics backend for Ratatui.
...
* [ratatui-splash-screen](https://github.com/orhun/ratatui-splash-screen) ⭐ 152 | 🐛 1 | 🌐 Rust | 📅 2026-08-31 - A widget to turn any image to a splash screen.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 44 | 🐛 4 | 🌐 Rust | 📅 2026-09-04 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [jatatui](https://github.com/oyvindberg/jatatui) ⭐ 285 | 🐛 1 | 🌐 Java | 📅 2026-08-22 - A Java port of ratatui.
* [pyratatui](https://github.com/pyratatui/pyratatui) ⭐ 144 | 🐛 1 | 🌐 Rust | 📅 2026-06-05 - Python bindings to ratatui, powered by Maturin and PyO3.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 113 | 🐛 0 | 🌐 Elixir | 📅 2026-09-03 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,926 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,461 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,861 | 🐛 293 | 🌐 Rust | 📅 2026-09-04 - Comprehensive Deep Learning framework in Rust.
...
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,311 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,906 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,077 | 🐛 23 | 🌐 Rust | 📅 2026-09-03 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,021 | 🐛 162 | 🌐 Rust | 📅 2026-09-04 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,768 | 🐛 40 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 920 | 🐛 9 | 🌐 Rust | 📅 2026-09-03 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 831 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 525 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 467 | 🐛 10 | 🌐 Rust | 📅 2026-09-03 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 289 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 277 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 225 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 18 | 🌐 Rust | 📅 2026-09-03 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 89 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 69 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 60 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 40 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [hedos](https://github.com/theiskaa/hedos) ⭐ 11 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 10 | 🐛 3 | 🌐 Rust | 📅 2026-09-03 - A terminal-native prompt composer for developers working with coding agents.
* [LimitDeck](https://github.com/rockythink/limitdeck) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A compact, privacy-safe terminal dashboard for AI coding subscription limits.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 11 | 🌐 Rust | 📅 2026-09-03 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,586 | 🐛 16 | 🌐 Rust | 📅 2026-09-03 - A CLI code-typing game that turns your source code into typing challenges.
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,167 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Terminal-based Chess game.
...
* [Maze TUI](https://github.com/agl-alexglopez/maze-tui) ⭐ 85 | 🐛 0 | 🌐 Rust | 📅 2025-10-24 - Beautiful visualizations of common maze building and graph searching algorithms.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A simple idle farming game.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,174 | 🐛 176 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,361 | 🐛 6 | 🌐 Rust | 📅 2026-09-02 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,303 | 🐛 30 | 🌐 Rust | 📅 2026-09-02 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,123 | 🐛 45 | 📅 2026-08-30 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 709 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [ytsub](https://github.com/sarowish/ytsub) ⭐ 89 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - A subscriptions only TUI YouTube client.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 90,034 | 🐛 1,106 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,511 | 🐛 2,515 | 🌐 Rust | 📅 2026-09-04 - A high-performance observability data pipeline.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,524 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,836 | 🐛 79 | 🌐 Rust | 📅 2026-09-04 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,993 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,067 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,831 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
...
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,649 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,138 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 74 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 72 | 🐛 12 | 🌐 Rust | 📅 2026-09-03 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,527 | 🐛 424 | 🌐 Rust | 📅 2026-09-04 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,239 | 🐛 83 | 🌐 Rust | 📅 2026-09-02 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,245 | 🐛 18 | 🌐 Shell | 📅 2026-09-01 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,492 | 🐛 129 | 🌐 Rust | 📅 2026-09-01 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,413 | 🐛 39 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,953 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,709 | 🐛 68 | 🌐 Rust | 📅 2026-09-03 - Run multiple commands in parallel and shows output of each command separately.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,096 | 🐛 31 | 🌐 Rust | 📅 2026-09-01 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 983 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 779 | 🐛 23 | 🌐 Rust | 📅 2026-09-02 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 604 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 544 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 415 | 🐛 11 | 🌐 Rust | 📅 2026-09-02 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [tmmpr](https://github.com/tanciaku/tmmpr) ⭐ 348 | 🐛 3 | 🌐 Rust | 📅 2026-05-15 - Terminal mind mapper.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 265 | 🐛 8 | 🌐 Rust | 📅 2026-09-03 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 215 | 🐛 13 | 🌐 Rust | 📅 2026-09-04 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 10 | 🌐 Rust | 📅 2026-09-03 - A TUI feed viewer.
...
* [termi](https://github.com/tuna4ll/termi) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A modal terminal code editor.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,353 | 🐛 41 | 🌐 Rust | 📅 2026-09-04 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,275 | 🐛 161 | 🌐 Rust | 📅 2026-09-04 - A matrix chat client with vim keybindings.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,972 | 🐛 108 | 🌐 Rust | 📅 2026-09-04 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,223 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,292 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,863 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,826 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,557 | 🐛 19 | 🌐 Rust | 📅 2026-09-04 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 923 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - A terminal app for managing Docker containers, inspired by K9s.
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 744 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 671 | 🐛 6 | 🌐 Rust | 📅 2026-09-03 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 353 | 🐛 11 | 🌐 Rust | 📅 2026-08-29 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 81 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-04 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A very feature-rich Modbus Client.
* [Mnyaoo32](https://github.com/intuis/mnyaoo32) ⭐ 34 | 🐛 1 | 🌐 Rust | 📅 2025-05-10 - An eccentric way to consume IRC messages using ESP32.

### 🌌 Other

* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,959 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 - A TUI screensaver that visualizes Git commit history in your terminal.
...
* [Inertia](https://github.com/aclfe/inertia) ⭐ 115 | 🐛 1 | 🌐 Rust | 📅 2026-07-19 - A 3D physics simulator in your terminal.
