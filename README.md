...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,694 | 🐛 213 | 🌐 Rust | 📅 2026-09-21
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,963 | 🐛 306 | 🌐 Rust | 📅 2026-09-21 - Comprehensive Deep Learning framework in Rust.
* [ratzilla](https://github.com/ratatui/ratzilla) ⭐ 1,455 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/ratatui/mousefood) ⭐ 1,329 | 🐛 23 | 🌐 Rust | 📅 2026-09-21 - An embedded-graphics backend for Ratatui.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 92 | 🐛 2 | 🌐 Rust | 📅 2026-09-21 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [ratatui-code-editor](https://github.com/vipmax/ratatui-code-editor) ⭐ 115 | 🐛 7 | 🌐 Rust | 📅 2026-07-07 - A code editor with syntax highlighting powered by tree-sitter.
...
* [pyratatui](https://github.com/programmersd21/pyratatui) ⭐ 165 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - Python bindings for Ratatui, implemented in Rust with PyO3.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 118 | 🐛 0 | 🌐 Elixir | 📅 2026-09-22 - Elixir bindings for ratatui.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,512 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,320 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,917 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,113 | 🐛 25 | 🌐 Rust | 📅 2026-09-22 - A rich Git commit graph in your terminal.
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,214 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - A TUI for the Jujutsu version-control system.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 536 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
...
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,327 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - A terminal UI for browsing and calling APIs from OpenAPI specifications.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 602 | 🐛 56 | 🌐 Rust | 📅 2026-09-21 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 437 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - A terminal tool for tracing which programs and commands are executed.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,311 | 🐛 65 | 🌐 Rust | 📅 2026-09-22 - An open-source desktop workspace for general-purpose AI agents.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,795 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 940 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 852 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - An open-source Rust coding agent for the terminal.
...
* [patent](https://github.com/r14dd/patent) ⭐ 528 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - A prior-art search for developer-tool ideas with an AI-generated verdict.
* [models](https://github.com/reyamira/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 482 | 🐛 9 | 🌐 Rust | 📅 2026-09-21 - Live pixel-art office for AI coding agents.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 237 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A local proxy that compresses large-language-model API requests to reduce token costs, with a dashboard for per-source costs and context usage.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 76 | 🐛 7 | 🌐 Rust | 📅 2026-09-20 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 74 | 🐛 6 | 🌐 Rust | 📅 2026-09-22 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
* [opencode stats](https://github.com/Cateds/opencode-stats) ⭐ 68 | 🐛 2 | 🌐 Rust | 📅 2026-08-04 - A terminal dashboard for OpenCode usage statistics and cost breakdowns.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 46 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 36 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - A terminal-native prompt composer for developers working with coding agents.
...
* [hedos](https://github.com/theiskaa/hedos) ⭐ 14 | 🐛 7 | 🌐 Rust | 📅 2026-09-21 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-09-22 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [savras](https://github.com/Marijusaj/savras) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - A side panel that sees every Claude Code session you have running: which are waiting on you, working, or done, with their PRs and context used.
* [lumen](https://github.com/blackopsrepl/lumen) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - Runs a ratatui app as an agent session and gives a human a live cell-grid view of it.

### 📁 Files, Data, and Documents

* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,350 | 🐛 61 | 🌐 Rust | 📅 2026-09-21 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,519 | 🐛 123 | 🌐 Rust | 📅 2026-09-21 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,435 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,979 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 551 | 🐛 25 | 🌐 Rust | 📅 2026-09-21 - Markdown renderer in the terminal.
* [otree](https://github.com/fioncat/otree) ⭐ 517 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A command line tool to view objects (JSON/YAML/TOML) in TUI tree widget.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 96 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,780 | 🐛 416 | 🌐 Rust | 📅 2026-09-22 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,282 | 🐛 78 | 🌐 Rust | 📅 2026-09-19 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,291 | 🐛 32 | 🌐 Rust | 📅 2026-09-21 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 430 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 392 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 301 | 🐛 47 | 🌐 Rust | 📅 2026-09-22 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,687 | 🐛 42 | 🌐 Rust | 📅 2026-09-18 - Ping tool with a graph.
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,044 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - A cross-platform network monitoring tool with deep packet inspection.
...
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,661 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,192 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 259 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 92,397 | 🐛 1,134 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,097 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
...
* [purple](https://github.com/erickochen/purple) ⭐ 699 | 🐛 5 | 🌐 Rust | 📅 2026-09-22 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,544 | 🐛 44 | 🌐 Rust | 📅 2026-09-22 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,289 | 🐛 108 | 🌐 Rust | 📅 2026-09-21 - A matrix chat client with vim keybindings.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,599 | 🐛 2,483 | 🌐 Rust | 📅 2026-09-22 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,038 | 🐛 104 | 🌐 Rust | 📅 2026-09-22 - Cross-platform graphical process/system monitor.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 463 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,852 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,291 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,294 | 🐛 22 | 🌐 Shell | 📅 2026-09-21 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,337 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 875 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,891 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-22 - A minimal serial monitor with plotter TUI.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 313 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [kanban](https://github.com/kanban-rs/kanban) ⭐ 169 | 🐛 14 | 🌐 Rust | 📅 2026-09-22 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,011 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 432 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 296 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 92 | 🐛 9 | 🌐 Rust | 📅 2026-09-21 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [rsstig](https://github.com/indium114/rsstig) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - An unconventional terminal RSS/Atom reader.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,231 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,373 | 🐛 35 | 🌐 Rust | 📅 2026-09-19 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 720 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A terminal audio scope with waveform, vector, and frequency views.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 238 | 🐛 12 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [O₂](https://github.com/coignard/o2) ⭐ 50 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - Rust port of the ORCΛ esoteric programming language and terminal livecoding environment.
...
* [Youta](https://github.com/vitaly-zdanevich/youta) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - An audio player for YouTube, Yandex Music, podcasts, audiobooks, radio, and local files.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,188 | 🐛 11 | 🌐 Rust | 📅 2026-09-21 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 931 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 773 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
...
* [Absotui](https://github.com/pdwaldrop/absotui) ⭐ 21 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 - A fast, keyboard-driven TUI client for Audiobookshelf (self-hosted audiobook/podcast server).
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,606 | 🐛 16 | 🌐 Rust | 📅 2026-09-19 - A CLI code-typing game that turns your source code into typing challenges.
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,182 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 - Terminal-based Chess game.
...
* [pokeductor](https://github.com/Huseynteymurzade28/pokeductor) ⭐ 54 | 🐛 5 | 🌐 Rust | 📅 2026-09-18 - A terminal Pokédex and evolution analyzer with sprite cards.
...
* [numr](https://github.com/nasedkinpv/numr) ⭐ 268 | 🐛 3 | 🌐 Rust | 📅 2026-07-14 - A natural language calculator with unit/currency conversions and vim-style keybindings.
