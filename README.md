...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,540 | 🐛 219 | 🌐 Rust | 📅 2026-09-07
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,447 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,324 | 🐛 22 | 🌐 Rust | 📅 2026-09-07 - An embedded-graphics backend for Ratatui.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 39 | 🐛 11 | 🌐 Rust | 📅 2026-09-08 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
...
* [edtui](https://github.com/preiter93/edtui) ⭐ 157 | 🐛 3 | 🌐 Rust | 📅 2026-08-16 - A TUI based vim-inspired editor widget for ratatui.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 46 | 🐛 5 | 🌐 Rust | 📅 2026-09-04 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 114 | 🐛 2 | 🌐 Elixir | 📅 2026-09-07 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,087 | 🐛 70 | 🌐 Rust | 📅 2026-09-09 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,473 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,890 | 🐛 311 | 🌐 Rust | 📅 2026-09-09 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,323 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management TUI for Postgres.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,726 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - Ranger-like terminal file manager written in Rust.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,720 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
...
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,116 | 🐛 77 | 🌐 Rust | 📅 2026-09-10 - An AI coding agent.
* [serie](https://github.com/lusingander/serie) ⭐ 2,091 | 🐛 24 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,778 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,404 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,322 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 931 | 🐛 27 | 🌐 Rust | 📅 2026-09-10 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 838 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - A Semantic Coding Agent.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 600 | 🐛 56 | 🌐 Rust | 📅 2026-09-05 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 531 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
* [patent](https://github.com/r14dd/patent) ⭐ 525 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 473 | 🐛 13 | 🌐 Rust | 📅 2026-09-09 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 302 | 🐛 7 | 🌐 Rust | 📅 2026-09-09 - Fast, driverless, Vim-first database TUI with safe editing and ER diagrams.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 293 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 91 | 🐛 2 | 🌐 Rust | 📅 2026-09-08 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 61 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 40 | 🐛 2 | 🌐 Rust | 📅 2026-09-09 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 37 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 28 | 🐛 13 | 🌐 Rust | 📅 2026-09-09 - A terminal-native prompt composer for developers working with coding agents.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,594 | 🐛 16 | 🌐 Rust | 📅 2026-09-09 - A CLI code-typing game that turns your source code into typing challenges.
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,172 | 🐛 32 | 🌐 Rust | 📅 2026-08-27 - Terminal-based Chess game.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 26 | 🐛 1 | 🌐 Rust | 📅 2026-09-09 - A simple idle farming game.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,196 | 🐛 154 | 🌐 Rust | 📅 2026-09-09 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,778 | 🐛 8 | 🌐 Rust | 📅 2026-09-09 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,328 | 🐛 32 | 🌐 Rust | 📅 2026-09-08 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,134 | 🐛 45 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 765 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 218 | 🐛 7 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 90,471 | 🐛 1,112 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,533 | 🐛 2,512 | 🌐 Rust | 📅 2026-09-09 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,676 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,959 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,539 | 🐛 57 | 🌐 Rust | 📅 2026-09-10 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,891 | 🐛 83 | 🌐 Rust | 📅 2026-09-09 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,012 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,075 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,844 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,577 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,150 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 96 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [ytunnel](https://github.com/yetidevworks/ytunnel) ⭐ 51 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - A TUI-first CLI for managing Cloudflare Tunnels with custom domains.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,574 | 🐛 408 | 🌐 Rust | 📅 2026-09-09 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,255 | 🐛 81 | 🌐 Rust | 📅 2026-09-08 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,252 | 🐛 20 | 🌐 Shell | 📅 2026-09-07 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,499 | 🐛 126 | 🌐 Rust | 📅 2026-09-08 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,420 | 🐛 38 | 🌐 Rust | 📅 2026-09-06 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,959 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,998 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
...
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,691 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,608 | 🐛 63 | 🌐 Rust | 📅 2026-09-05 - A fast, keyboard-driven terminal UI for todo.txt.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,593 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,244 | 🐛 31 | 🌐 Rust | 📅 2026-09-10 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,001 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [models](https://github.com/arimxyer/models) ⭐ 505 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 418 | 🐛 9 | 🌐 Rust | 📅 2026-09-08 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 300 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 292 | 🐛 45 | 🌐 Rust | 📅 2026-09-07 - A command line tool that executes make target using fuzzy finder with preview window.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 289 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 168 | 🐛 7 | 🌐 Rust | 📅 2026-09-09 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 138 | 🐛 18 | 🌐 Rust | 📅 2026-09-07 - Task Aggregator TUI for N providers.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 29 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [ratslate](https://github.com/azihsoyn/ratslate) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - An infinite-canvas whiteboard driven by the mouse.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 3 | 🐛 14 | 🌐 Rust | 📅 2026-09-09 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,459 | 🐛 42 | 🌐 Rust | 📅 2026-09-09 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,276 | 🐛 157 | 🌐 Rust | 📅 2026-09-08 - A matrix chat client with vim keybindings.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 16 | 🌐 Rust | 📅 2026-09-08 - A TUI client for Nostr.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,008 | 🐛 106 | 🌐 Rust | 📅 2026-09-10 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,244 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - Hackable, minimal, and fast TUI file explorer.
...
* [bpftop](https://github.com/Netflix/bpftop) ⭐ 2,704 | 🐛 5 | 🌐 C | 📅 2026-09-01 - Dynamic real-time view of running eBPF programs.
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,532 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast dashboard for Kubernetes.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,310 | 🐛 53 | 🌐 Rust | 📅 2026-09-09 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,873 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,833 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) ⭐ 1,577 | 🐛 5 | 🌐 Rust | 📅 2026-09-10 - A program for managing systemd services through a TUI.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,560 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 927 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - A terminal app for managing Docker containers, inspired by K9s.
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 757 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 679 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 104 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A terminal-based tool for browsing Kubernetes resources.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-09 - A very feature-rich Modbus Client.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,749 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
...
* [sigye](https://github.com/am2rican5/sigye) ⭐ 127 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
