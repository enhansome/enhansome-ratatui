...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,329 | 🐛 229 | 🌐 Rust | 📅 2026-08-22
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,431 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,314 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - An embedded-graphics backend for Ratatui.
...
* [tachyonfx](https://github.com/junkdog/tachyonfx) ⭐ 1,287 | 🐛 7 | 🌐 Rust | 📅 2026-07-19 - A shader-like effects library for ratatui.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 112 | 🐛 0 | 🌐 Elixir | 📅 2026-08-20 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,610 | 🐛 65 | 🌐 Rust | 📅 2026-08-22 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,416 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,801 | 🐛 301 | 🌐 Rust | 📅 2026-08-21 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,701 | 🐛 21 | 🌐 Rust | 📅 2026-03-09 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,317 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,300 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,881 | 🐛 59 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,050 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,806 | 🐛 105 | 🌐 Rust | 📅 2026-08-22 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,746 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,374 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,305 | 🐛 10 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 907 | 🐛 4 | 🌐 Rust | 📅 2026-08-23 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 816 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - A Semantic Coding Agent.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 254 | 🐛 8 | 🌐 Rust | 📅 2026-08-22 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [tongo](https://github.com/drewzemke/tongo) ⭐ 71 | 🐛 2 | 🌐 Rust | 📅 2026-08-22 - A TUI for MongoDB.
...
* [gimoji](https://github.com/zeenix/gimoji) ⭐ 52 | 🐛 7 | 🌐 Rust | 📅 2026-08-22 - Makes it easy to add emojis to your Git commit messages.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 48 | 🐛 2 | 🌐 Rust | 📅 2026-08-22 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 10 | 🐛 2 | 🌐 Rust | 📅 2026-08-22 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 6 | 🐛 5 | 🌐 Rust | 📅 2026-08-23 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 2 | 🐛 6 | 🌐 Rust | 📅 2026-08-22 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,315 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,107 | 🐛 165 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,291 | 🐛 8 | 🌐 Rust | 📅 2026-08-21 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,247 | 🐛 27 | 🌐 Rust | 📅 2026-08-22 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,103 | 🐛 47 | 🌐 Rust | 📅 2026-08-08 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 699 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 370 | 🐛 3 | 🌐 Rust | 📅 2026-08-22 - A lightweight, customizable TUI music player for local files.
* [fum](https://github.com/qxb3/fum) ⭐ 284 | 🐛 5 | 🌐 Rust | 📅 2026-07-11 - A fully ricable tui-based music client.
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 200 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,005 | 🐛 1,088 | 🌐 Dart | 📅 2026-08-21
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,435 | 🐛 2,525 | 🌐 Rust | 📅 2026-08-22 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,634 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,913 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,501 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,515 | 🐛 76 | 🌐 Rust | 📅 2026-08-22 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,894 | 🐛 17 | 🌐 Rust | 📅 2026-08-22 - A cross-platform network monitoring tool with deep packet inspection.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,790 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi on Linux.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,089 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,381 | 🐛 408 | 🌐 Rust | 📅 2026-08-22 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,198 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,227 | 🐛 12 | 🌐 Shell | 📅 2026-08-17 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,480 | 🐛 121 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,396 | 🐛 35 | 🌐 Rust | 📅 2026-08-23 - A TUI for analyzing binary files.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,699 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,109 | 🐛 130 | 🌐 Rust | 📅 2026-08-16 - TUI for the Taskwarrior command-line task manager.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,583 | 🐛 52 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,073 | 🐛 24 | 🌐 Rust | 📅 2026-08-19 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 940 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 535 | 🐛 19 | 🌐 Rust | 📅 2026-08-18 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 494 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 425 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
...
* [hexhog](https://github.com/DVDTSB/hexhog) ⭐ 279 | 🐛 9 | 🌐 Rust | 📅 2026-02-16 - TUI Hex Editor/Viewer.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 238 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - Fuzzy picker (FZF reboot).
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 213 | 🐛 14 | 🌐 Rust | 📅 2026-08-23 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 137 | 🐛 18 | 🌐 Rust | 📅 2026-08-21 - Task Aggregator TUI for N providers.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2026-08-22 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [absorb](https://github.com/kloki/absorb) ⭐ 17 | 🐛 0 | 🌐 Rust | 📅 2026-04-11 - Quickly read a file without moving your eyes.
...
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,266 | 🐛 166 | 🌐 Rust | 📅 2026-08-23 - A matrix chat client with vim keybindings.
* [concord](https://github.com/chojs23/concord) ⭐ 1,254 | 🐛 38 | 🌐 Rust | 📅 2026-08-21 - A TUI client for Discord.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 - TUI for the lobste.rs website.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,158 | 🐛 36 | 🌐 Rust | 📅 2026-08-16 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,219 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,823 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,814 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,551 | 🐛 18 | 🌐 Rust | 📅 2026-08-23 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 716 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 645 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-22 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 349 | 🐛 10 | 🌐 Rust | 📅 2026-08-16 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 104 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
* [b4n](https://github.com/fioletoven/b4n) ⭐ 102 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 - A terminal-based tool for browsing Kubernetes resources.
...
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,347 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,068 | 🐛 10 | 🌐 Rust | 📅 2026-08-10 - Alternative watch command with command history and diffs.
...
* [cotp](https://github.com/replydev/cotp) ⭐ 385 | 🐛 5 | 🌐 Rust | 📅 2026-08-10 - Command-line TOTP/HOTP authenticator app.
...
* [mlbt](https://github.com/mlb-rs/mlbt) ⭐ 158 | 🐛 1 | 🌐 Rust | 📅 2026-07-04 - A tui for the MLB Statcast API. Watch a live game using Gameday, or check scores, standings, and stats.
