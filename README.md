...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,462 | 🐛 225 | 🌐 Rust | 📅 2026-08-31
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,438 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,321 | 🐛 25 | 🌐 Rust | 📅 2026-08-31 - An embedded-graphics backend for Ratatui.
...
* [egui-ratatui](https://github.com/gold-silver-copper/egui_ratatui) ⭐ 208 | 🐛 4 | 🌐 Rust | 📅 2026-04-16 - A ratatui backend that is also an egui widget. Deploy on web with WebAssembly or ship natively with bevy, macroquad, or eframe.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 38 | 🐛 11 | 🌐 Rust | 📅 2026-08-27 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-08-26 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [edtui](https://github.com/preiter93/edtui) ⭐ 155 | 🐛 3 | 🌐 Rust | 📅 2026-08-16 - A TUI based vim-inspired editor widget for ratatui.
* [ratatui-splash-screen](https://github.com/orhun/ratatui-splash-screen) ⭐ 151 | 🐛 1 | 🌐 Rust | 📅 2026-08-31 - A widget to turn any image to a splash screen.
...
* [ratatui-explorer](https://github.com/tatounee/ratatui-explorer) ⭐ 93 | 🐛 3 | 🌐 Rust | 📅 2026-03-06 - A simple library for creating file explorer for ratatui.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 42 | 🐛 2 | 🌐 Rust | 📅 2026-08-31 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [tachyonfx](https://github.com/junkdog/tachyonfx) ⭐ 1,292 | 🐛 7 | 🌐 Rust | 📅 2026-07-19 - A shader-like effects library for ratatui.
...
* [jatatui](https://github.com/oyvindberg/jatatui) ⭐ 283 | 🐛 1 | 🌐 Java | 📅 2026-08-22 - A Java port of ratatui.
* [pyratatui](https://github.com/pyratatui/pyratatui) ⭐ 143 | 🐛 1 | 🌐 Rust | 📅 2026-06-05 - Python bindings to ratatui, powered by Maturin and PyO3.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 112 | 🐛 0 | 🌐 Elixir | 📅 2026-09-01 - Elixir bindings for ratatui.
* [ratatui-ffi](https://github.com/holo-q/ratatui-ffi) ⭐ 54 | 🐛 2 | 🌐 Rust | 📅 2026-06-04 - FFI bindings for ratatui.
...
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,451 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,844 | 🐛 300 | 🌐 Rust | 📅 2026-09-01 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,313 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management TUI for Postgres.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,724 | 🐛 103 | 🌐 Rust | 📅 2026-08-20 - Ranger-like terminal file manager written in Rust.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,709 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,315 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,309 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,906 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,069 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,884 | 🐛 192 | 🌐 Rust | 📅 2026-09-01 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,763 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,375 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,312 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [desed](https://github.com/SoptikHa2/desed) ⭐ 1,217 | 🐛 7 | 🌐 Rust | 📅 2026-05-16 - Debugging tool for sed scripts.
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,202 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 917 | 🐛 20 | 🌐 Rust | 📅 2026-08-31 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 825 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - A Semantic Coding Agent.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 527 | 🐛 3 | 🌐 Rust | 📅 2026-08-30 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
* [patent](https://github.com/r14dd/patent) ⭐ 524 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 463 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - Live pixel-art office for AI coding agents.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 437 | 🐛 26 | 🌐 Rust | 📅 2026-08-31 - Tracer for execve{,at} and pre-exec behavior, launcher for debuggers.
* [Yozefu](https://github.com/MAIF/yozefu/) ⭐ 344 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - A TUI for exploring data of a Kafka cluster.
* [giff](https://github.com/bahdotsh/giff) ⭐ 272 | 🐛 8 | 🌐 Rust | 📅 2026-04-23 - A TUI for Git diffs with interactive rebase support.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 271 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 260 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
* [glim](https://github.com/junkdog/glim) ⭐ 234 | 🐛 16 | 🌐 Rust | 📅 2025-10-13 - Monitor GitLab CI/CD pipelines and projects with style.
* [FileSSH](https://github.com/JayanAXHF/filessh) ⭐ 229 | 🐛 3 | 🌐 Rust | 📅 2026-07-25 - A TUI-based file explorer for remote servers.
* [deadbranch](https://github.com/armgabrielyan/deadbranch) ⭐ 228 | 🐛 2 | 🌐 Rust | 📅 2026-03-30 - A TUI for cleaning stale Git branches safely.
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 228 | 🐛 6 | 🌐 Rust | 📅 2026-08-30 - Real-time terminal file diff monitoring TUI.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 222 | 🐛 10 | 🌐 Rust | 📅 2026-08-17 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 20 | 🌐 Rust | 📅 2026-08-31 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 89 | 🐛 1 | 🌐 Rust | 📅 2026-07-27 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [nomad](https://github.com/JosephLai241/nomad) ⭐ 73 | 🐛 9 | 🌐 Rust | 📅 2023-05-10 - Customizable next-gen tree command with Git integration and TUI.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 67 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 59 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [gimoji](https://github.com/zeenix/gimoji) ⭐ 52 | 🐛 7 | 🌐 Rust | 📅 2026-08-31 - Makes it easy to add emojis to your Git commit messages.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 40 | 🐛 5 | 🌐 Rust | 📅 2026-08-20 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
* [deputui](https://github.com/twiddler/deputui) ⭐ 36 | 🐛 4 | 🌐 Rust | 📅 2026-08-31 - Review and install NPM package updates.
* [lingora-tui](https://github.com/nigeleke/lingora) ⭐ 35 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - Browse, compare and validate Fluent i18n files.
* [material](https://github.com/azorng/material) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 - A material design color palette for the terminal.
* [amtr](https://github.com/arian-shamaei/anthropometer) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - A btop-style TUI that renders a Claude Code session's live context window as a memory map, with tool and file traffic, cache economics, and a compiled PDF report.
...
* [blippy](https://github.com/AksharP5/blippy) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A keyboard-first TUI for GitHub issues and pull requests.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A local dashboard for Codex and Claude Code.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 12 | 🐛 4 | 🌐 Rust | 📅 2026-08-31 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [stevedore](https://github.com/takumiymd/stevedore) ⭐ 11 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A fast, keyboard-driven terminal UI for managing Docker containers and Compose stacks.
* [hedos](https://github.com/theiskaa/hedos) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 11 | 🌐 Rust | 📅 2026-08-31 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [VLE](https://github.com/tuffy/vle) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A lightweight text editor.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 3 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,165 | 🐛 31 | 🌐 Rust | 📅 2026-08-27 - Terminal-based Chess game.
...
* [crosstui](https://github.com/matrixfrog/crossword) ⭐ 54 | 🐛 12 | 🌐 Rust | 📅 2025-07-31 - Terminal-based crossword puzzle player.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - A simple idle farming game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,342 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,159 | 🐛 174 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,337 | 🐛 10 | 🌐 Rust | 📅 2026-08-31 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,290 | 🐛 36 | 🌐 Rust | 📅 2026-08-29 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,113 | 🐛 45 | 📅 2026-08-30 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 928 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 762 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 707 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 210 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
* [glicol-cli](https://github.com/glicol/glicol-cli) ⭐ 193 | 🐛 13 | 🌐 Rust | 📅 2024-12-09 - Cross-platform music live coding in terminal.
* [mal-cli](https://github.com/L4z3x/mal-cli) ⭐ 161 | 🐛 0 | 🌐 Rust | 📅 2025-07-17 - A TUI for myanimelist.
...
* [ytsub](https://github.com/sarowish/ytsub) ⭐ 89 | 🐛 2 | 🌐 Rust | 📅 2026-08-28 - A subscriptions only TUI YouTube client.
...
* [sparkplayer](https://github.com/dividebysandwich/sparkplayer/tree/main) ⭐ 51 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A fun terminal based media player with album art and video support.
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 48 | 🐛 2 | 🌐 Rust | 📅 2026-08-28 - Deezer music TUI with included background player.
...
* [audium](https://github.com/takashialpha/audium) ⭐ 37 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - A keyboard-driven music app for people who live in the terminal.
...
* [tusic](https://github.com/eminfedar/tusic) ⭐ 20 | 🐛 1 | 🌐 Rust | 📅 2026-07-15 - Lightweight TUI Music Player. Play from YouTube or \~/Music folder easily.
...
* [ytmusic-tui](https://github.com/WakaTaira/ytmusic-tui) ⭐ 2 | 🐛 11 | 🌐 Rust | 📅 2026-06-19 - TUI client for YouTube Music with vim-style keybindings, spotify-player-inspired navigation, and MPRIS2 support.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,842 | 🐛 1,096 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,499 | 🐛 2,513 | 🌐 Rust | 📅 2026-09-01 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,667 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,941 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,521 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,738 | 🐛 80 | 🌐 Rust | 📅 2026-09-01 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,979 | 🐛 15 | 🌐 Rust | 📅 2026-08-31 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,060 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,819 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,572 | 🐛 5 | 🌐 Rust | 📅 2026-08-28 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,831 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,645 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,128 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 721 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - MQTT client for subscribing or publishing to topics.
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 645 | 🐛 23 | 🌐 Rust | 📅 2026-08-31 - Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 250 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 70 | 🐛 12 | 🌐 Rust | 📅 2026-09-01 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [ytunnel](https://github.com/yetidevworks/ytunnel) ⭐ 49 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - A TUI-first CLI for managing Cloudflare Tunnels with custom domains.
* [rrtop](https://github.com/wojciech-zurek/rrtop) ⭐ 43 | 🐛 0 | 🌐 Rust | 📅 2021-08-05 - Redis monitoring (top like) app. rrtop -> \[r]ust \[r]edis \[top].
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [yscan](https://github.com/yetidevworks/yscan) ⭐ 8 | 🐛 3 | 🌐 Rust | 📅 2026-08-04 - A TUI-first network scanner with ARP, mDNS, and SSDP discovery.
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

### 🚀 Productivity and Utilities

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,484 | 🐛 416 | 🌐 Rust | 📅 2026-09-01 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,228 | 🐛 84 | 🌐 Rust | 📅 2026-08-31 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,241 | 🐛 18 | 🌐 Shell | 📅 2026-09-01 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,488 | 🐛 125 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,411 | 🐛 38 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,949 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,121 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,092 | 🐛 15 | 🌐 Rust | 📅 2026-09-01 - A lightweight TUI app to view and query CSV files.
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,987 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,709 | 🐛 67 | 🌐 Rust | 📅 2026-08-29 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,117 | 🐛 132 | 🌐 Rust | 📅 2026-08-30 - TUI for the Taskwarrior command-line task manager.
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,755 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Manage your GnuPG keys with ease!.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,686 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,593 | 🐛 60 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,592 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,092 | 🐛 25 | 🌐 Rust | 📅 2026-09-01 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 959 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [stu](https://github.com/lusingander/stu) ⭐ 907 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - A TUI for AWS S3.
* [igrep](https://github.com/konradsz/igrep) ⭐ 842 | 🐛 11 | 🌐 Rust | 📅 2026-02-01 - Interactive Grep.
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 775 | 🐛 24 | 🌐 Rust | 📅 2026-08-16 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 600 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 542 | 🐛 20 | 🌐 Rust | 📅 2026-08-31 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A TUI for browsing AI models, benchmarks, and coding agents.
* [blendr](https://github.com/dmtrKovalenko/blendr) ⭐ 491 | 🐛 6 | 🌐 Rust | 📅 2024-09-01 - The hacker's BLE (bluetooth low energy) browser terminal app.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 430 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 415 | 🐛 11 | 🌐 Rust | 📅 2026-08-31 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 393 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [timr-tui](https://github.com/sectore/timr-tui) ⭐ 371 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - TUI to organize your time: Pomodoro, Countdown, Timer, Event.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 293 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 292 | 🐛 46 | 🌐 Rust | 📅 2026-09-01 - A command line tool that executes make target using fuzzy finder with preview window.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 292 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 238 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 - Fuzzy picker (FZF reboot).
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 214 | 🐛 15 | 🌐 Rust | 📅 2026-08-30 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 153 | 🐛 10 | 🌐 Rust | 📅 2026-08-29 - A TUI feed viewer.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 137 | 🐛 18 | 🌐 Rust | 📅 2026-08-31 - Task Aggregator TUI for N providers.
...
* [rdn](https://github.com/apatrushev/rdn) ⭐ 81 | 🐛 0 | 🌐 Rust | 📅 2026-03-17 - Rust port of well known old Dos Navigator.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 44 | 🐛 2 | 🌐 Rust | 📅 2026-08-26 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
* [meteo-tui](https://github.com/16arpi/meteo-tui) ⭐ 42 | 🐛 1 | 🌐 Rust | 📅 2026-07-21 - French weather app in the command line.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 28 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A TUI calendar with Google Calendar sync and DAG-linked events.
* [revw](https://github.com/rlelf/revw) ⭐ 17 | 🐛 0 | 🌐 Rust | 📅 2026-04-04 - A vim-like TUI for managing notes and resources.
* [pgmon](https://github.com/nbari/pgmon) ⭐ 14 | 🐛 2 | 🌐 Rust | 📅 2026-07-01 - A TUI for monitoring PostgresSQL databases.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 0 | 🐛 12 | 🌐 Rust | 📅 2026-08-31 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,294 | 🐛 42 | 🌐 Rust | 📅 2026-08-31 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,272 | 🐛 163 | 🌐 Rust | 📅 2026-09-01 - A matrix chat client with vim keybindings.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - A TUI client for Nostr.
* [rvIRC](https://github.com/KaraZajac/rvIRC) ⭐ 24 | 🐛 0 | 🌐 Rust | 📅 2026-05-17 - A TUI client for IRC.
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-30 - TUI for the lobste.rs website.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,960 | 🐛 106 | 🌐 Rust | 📅 2026-09-01 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,202 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,813 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - Hackable, minimal, and fast TUI file explorer.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,045 | 🐛 40 | 🌐 Rust | 📅 2026-08-25 - Cross-platform monitoring tool for system stats.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,281 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,857 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,824 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,555 | 🐛 19 | 🌐 Rust | 📅 2026-08-31 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 922 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - A terminal app for managing Docker containers, inspired by K9s.
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 741 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 665 | 🐛 6 | 🌐 Rust | 📅 2026-08-31 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 353 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [mirro-rs](https://github.com/rtkay123/mirro-rs) ⭐ 117 | 🐛 23 | 🌐 Rust | 📅 2026-08-26 - An Arch Linux mirrorlist manager with a TUI.
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 113 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 103 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - A terminal-based tool for browsing Kubernetes resources.
...
* [napwatch](https://github.com/Tuguberk/napwatch) ⭐ 69 | 🐛 0 | 🌐 Rust | 📅 2026-07-19 - Diagnoses and controls macOS power/battery behavior: dark wakes, Power Nap, live drain rate, and per-process power draw.
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 69 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [pacman-utils](https://github.com/ankur3-101106/pacman-utils) ⭐ 11 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - A TUI for pacman, works on Arch-based Distros.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 169 | 🐛 3 | 🌐 Rust | 📅 2026-09-01 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - A very feature-rich Modbus Client.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,745 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,354 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,074 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 - Alternative watch command with command history and diffs.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 693 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa.si tui tool for browsing and downloading torrents.
...
* [tenki](https://github.com/ckaznable/tenki) ⭐ 168 | 🐛 0 | 🌐 Rust | 📅 2026-07-23 - A tty-clock with weather effect.
* [mlbt](https://github.com/mlb-rs/mlbt) ⭐ 160 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A tui for the MLB Statcast API. Watch a live game using Gameday, or check scores, standings, and stats.
* [sigye](https://github.com/am2rican5/sigye) ⭐ 123 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
* [Inertia](https://github.com/aclfe/inertia) ⭐ 114 | 🐛 1 | 🌐 Rust | 📅 2026-07-19 - A 3D physics simulator in your terminal.
...
* [confetty\_rs](https://github.com/Handfish/confetty_rs) ⭐ 87 | 🐛 1 | 🌐 Rust | 📅 2024-02-08 - Particle system (fireworks, stars) rendered in the terminal.
...
* [cpustate-tui](https://github.com/mkulke/cpustate-tui) ⭐ 17 | 🐛 0 | 🌐 Rust | 📅 2026-02-19 - Baremetal program to visualize x86\_64 CPU state.
