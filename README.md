...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,285 | 🐛 235 | 🌐 Rust | 📅 2026-08-19
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 109 | 🐛 4 | 🌐 Elixir | 📅 2026-08-17 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,504 | 🐛 65 | 🌐 Rust | 📅 2026-08-19 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,409 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,781 | 🐛 301 | 🌐 Rust | 📅 2026-08-19 - Comprehensive Deep Learning framework in Rust.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,853 | 🐛 62 | 🌐 Rust | 📅 2026-08-16 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,036 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,798 | 🐛 101 | 🌐 Rust | 📅 2026-08-20 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,741 | 🐛 38 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 902 | 🐛 8 | 🌐 Rust | 📅 2026-08-20 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 858 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 811 | 🐛 1 | 🌐 Rust | 📅 2026-08-19 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 521 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 449 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 251 | 🐛 5 | 🌐 Rust | 📅 2026-08-19 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 204 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 46 | 🐛 4 | 🌐 Rust | 📅 2026-08-20 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 41 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 10 | 🐛 4 | 🌐 Rust | 📅 2026-08-18 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 7 | 🌐 Rust | 📅 2026-08-20 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 6 | 🐛 6 | 🌐 Rust | 📅 2026-08-20 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 25 | 🐛 1 | 🌐 Rust | 📅 2026-08-19 - A simple idle farming game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,309 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,092 | 🐛 165 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,239 | 🐛 27 | 🌐 Rust | 📅 2026-08-19 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 919 | 🐛 22 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 696 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 359 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - A lightweight, customizable TUI music player for local files.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 186 | 🐛 9 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 45 | 🐛 3 | 🌐 Rust | 📅 2026-08-17 - Deezer music TUI with included background player.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 88,760 | 🐛 1,084 | 🌐 Dart | 📅 2026-08-19
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,409 | 🐛 2,523 | 🌐 Rust | 📅 2026-08-20 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,627 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 - Ping tool with a graph.
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,504 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,871 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,052 | 🐛 7 | 🌐 Rust | 📅 2026-07-29 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,786 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,558 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI for sniffing network traffic using eBPF.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,018 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 715 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 - MQTT client for subscribing or publishing to topics.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 241 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 70 | 🐛 9 | 🌐 Rust | 📅 2026-08-20 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,336 | 🐛 403 | 🌐 Rust | 📅 2026-08-20 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,184 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,224 | 🐛 11 | 🌐 Shell | 📅 2026-08-17 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
...
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,936 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,579 | 🐛 50 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,061 | 🐛 23 | 🌐 Rust | 📅 2026-08-19 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [models](https://github.com/arimxyer/models) ⭐ 493 | 🐛 0 | 🌐 Rust | 📅 2026-08-20 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 394 | 🐛 8 | 🌐 Rust | 📅 2026-08-20 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 286 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 238 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - Fuzzy picker (FZF reboot).
...
* [codemark](https://github.com/DanielCardonaRojas/codemark) ⭐ 120 | 🐛 7 | 🌐 Rust | 📅 2026-08-19 - A semantic code bookmarking system for humans and agents.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 74 | 🐛 9 | 🌐 Rust | 📅 2026-08-19 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,263 | 🐛 170 | 🌐 Rust | 📅 2026-08-18 - A matrix chat client with vim keybindings.
* [concord](https://github.com/chojs23/concord) ⭐ 1,240 | 🐛 40 | 🌐 Rust | 📅 2026-08-19 - A TUI client for Discord.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,148 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,806 | 🐛 14 | 🌐 Rust | 📅 2026-08-17 - Hackable, minimal, and fast TUI file explorer.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,816 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,810 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,549 | 🐛 16 | 🌐 Rust | 📅 2026-08-19 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 707 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 474 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 97 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A terminal-based tool for browsing Kubernetes resources.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 167 | 🐛 5 | 🌐 Rust | 📅 2026-07-18 - A minimal serial monitor with plotter TUI.
...
* [ttysvr](https://github.com/cxreiff/ttysvr) ⭐ 490 | 🐛 4 | 🌐 Rust | 📅 2026-07-04 - Screen saver for your terminal.
...
* [SeqTUI](https://github.com/ranwez-search/SeqTUI) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2026-03-10 - A terminal-based viewer and command-line toolkit for molecular sequences.
