...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,587 | 🐛 215 | 🌐 Rust | 📅 2026-09-14
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,451 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,327 | 🐛 22 | 🌐 Rust | 📅 2026-09-07 - An embedded-graphics backend for Ratatui.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 89 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 42 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
* [ratatui-kit](https://github.com/yexiyue/ratatui-kit) ⭐ 42 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A React-style component framework for Ratatui with hooks, routing, async state, input layers, and reusable components.
...
* [edtui](https://github.com/preiter93/edtui) ⭐ 157 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - A TUI based vim-inspired editor widget for ratatui.
* [ratatui-splash-screen](https://github.com/orhun/ratatui-splash-screen) ⭐ 154 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - A widget to turn any image to a splash screen.
...
* [tui-menu](https://github.com/shuoli84/tui-menu) ⭐ 56 | 🐛 2 | 🌐 Rust | 📅 2025-12-30 - A menu widget for ratatui ecosystem.
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 46 | 🐛 8 | 🌐 Rust | 📅 2026-09-11 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [tachyonfx](https://github.com/junkdog/tachyonfx) ⭐ 1,296 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 - A shader-like effects library for ratatui.
* [bevy\_ratatui](https://github.com/joshka/bevy_ratatui) ⭐ 171 | 🐛 8 | 🌐 Rust | 📅 2026-09-11 - A Rust crate to use Ratatui in a Bevy App.
...
* [pyratatui](https://github.com/pyratatui/pyratatui) ⭐ 147 | 🐛 1 | 🌐 Rust | 📅 2026-06-05 - Python bindings to ratatui, powered by Maturin and PyO3.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 116 | 🐛 1 | 🌐 Elixir | 📅 2026-09-13 - Elixir bindings for ratatui.
* [ratatui-ffi](https://github.com/holo-q/ratatui-ffi) ⭐ 54 | 🐛 2 | 🌐 Rust | 📅 2026-06-04 - FFI bindings for ratatui.
* [ratatui-py](https://github.com/holo-q/ratatui-py) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-06-04 - Python bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,177 | 🐛 65 | 🌐 Rust | 📅 2026-09-12 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,482 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,914 | 🐛 314 | 🌐 Rust | 📅 2026-09-11 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,329 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management TUI for Postgres.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,728 | 🐛 102 | 🌐 Rust | 📅 2026-08-20 - Ranger-like terminal file manager written in Rust.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,724 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,318 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,912 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,125 | 🐛 78 | 🌐 Rust | 📅 2026-09-14 - An AI coding agent.
* [serie](https://github.com/lusingander/serie) ⭐ 2,098 | 🐛 25 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,782 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,412 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,209 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 935 | 🐛 37 | 🌐 Rust | 📅 2026-09-13 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 842 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A Semantic Coding Agent.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 601 | 🐛 57 | 🌐 Rust | 📅 2026-09-05 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [patent](https://github.com/r14dd/patent) ⭐ 526 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 476 | 🐛 8 | 🌐 Rust | 📅 2026-09-13 - Live pixel-art office for AI coding agents.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 438 | 🐛 27 | 🌐 Rust | 📅 2026-09-07 - Tracer for execve{,at} and pre-exec behavior, launcher for debuggers.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 299 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [giff](https://github.com/bahdotsh/giff) ⭐ 275 | 🐛 8 | 🌐 Rust | 📅 2026-04-23 - A TUI for Git diffs with interactive rebase support.
* [glim](https://github.com/junkdog/glim) ⭐ 234 | 🐛 17 | 🌐 Rust | 📅 2025-10-13 - Monitor GitLab CI/CD pipelines and projects with style.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 229 | 🐛 14 | 🌐 Rust | 📅 2026-09-08 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [toktop](https://github.com/htin1/toktop) ⭐ 174 | 🐛 5 | 🌐 Rust | 📅 2025-12-07 - A LLM usage monitor in terminal.
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 26 | 🌐 Rust | 📅 2026-09-14 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 93 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 74 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 68 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [nereid](https://github.com/bnomei/nereid) ⭐ 65 | 🐛 0 | 🌐 Rust | 📅 2026-07-11 - Create and explore Mermaid diagrams in collaboration with AI agents (TUI + MCP Server).
* [opencode stats](https://github.com/Cateds/opencode-stats) ⭐ 65 | 🐛 2 | 🌐 Rust | 📅 2026-08-04 - A terminal dashboard for OpenCode usage statistics and cost breakdowns.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 64 | 🐛 4 | 🌐 Rust | 📅 2026-09-13 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
* [ygrep](https://github.com/yetidevworks/ygrep) ⭐ 58 | 🐛 2 | 🌐 Rust | 📅 2026-09-14 - A fast, local, indexed code search tool with a TUI, optimized for AI coding assistants and powered by Tantivy full-text indexing.
...
* [lingora-tui](https://github.com/nigeleke/lingora) ⭐ 35 | 🐛 4 | 🌐 Rust | 📅 2026-09-14 - Browse, compare and validate Fluent i18n files.
* [material](https://github.com/azorng/material) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 - A material design color palette for the terminal.
* [Proqi](https://github.com/oborchers/proqi) ⭐ 29 | 🐛 9 | 🌐 Rust | 📅 2026-09-14 - A terminal-native prompt composer for developers working with coding agents.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 21 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A local dashboard for Codex and Claude Code.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 8 | 🐛 4 | 🌐 Rust | 📅 2026-09-14 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 4 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 1 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - Real-time terminal file diff monitoring TUI.
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,599 | 🐛 16 | 🌐 Rust | 📅 2026-09-09 - A CLI code-typing game that turns your source code into typing challenges.
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,175 | 🐛 35 | 🌐 Rust | 📅 2026-09-10 - Terminal-based Chess game.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,207 | 🐛 154 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,948 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,344 | 🐛 33 | 🌐 Rust | 📅 2026-09-13 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,141 | 🐛 46 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 768 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 718 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 223 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [rusty-pipes](https://github.com/dividebysandwich/rusty-pipes) ⭐ 94 | 🐛 7 | 🌐 Rust | 📅 2026-06-22 - Sample-based, MIDI-controlled virtual pipe organ instrument.
...
* [Absotui](https://github.com/pdwaldrop/absotui) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven TUI client for Audiobookshelf (self-hosted audiobook/podcast server).
...
* [Youta](https://github.com/vitaly-zdanevich/youta) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - An audio player for YouTube, Yandex Music, podcasts, audiobooks, radio, and local files.
...
* [ytmusic-tui](https://github.com/WakaTaira/ytmusic-tui) ⭐ 4 | 🐛 11 | 🌐 Rust | 📅 2026-06-19 - TUI client for YouTube Music with vim-style keybindings, spotify-player-inspired navigation, and MPRIS2 support.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 90,940 | 🐛 1,118 | 🌐 Dart | 📅 2026-09-12
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,549 | 🐛 2,494 | 🌐 Rust | 📅 2026-09-11 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,677 | 🐛 39 | 🌐 Rust | 📅 2026-09-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,965 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,544 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,920 | 🐛 85 | 🌐 Rust | 📅 2026-09-14 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,021 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - A cross-platform network monitoring tool with deep packet inspection.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,850 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,579 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,845 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,658 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,154 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 726 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT client for subscribing or publishing to topics.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 256 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [wireman](https://github.com/preiter93/wireman) ⭐ 179 | 🐛 6 | 🌐 Rust | 📅 2026-09-12 - A gRPC client for the terminal.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 103 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [ytunnel](https://github.com/yetidevworks/ytunnel) ⭐ 52 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - A TUI-first CLI for managing Cloudflare Tunnels with custom domains.
...
* [dsnitch](https://github.com/infomaniac777/dsnitch) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-09-04 - Real-time network and DNS egress inspector TUI for Docker containers powered by eBPF.
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
* [jdtui](https://github.com/rylos/jdtui) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A TUI for JDownloader 2 over the My.JDownloader API: downloads, link grabber, accounts and settings, from anywhere.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

### 🚀 Productivity and Utilities

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,615 | 🐛 433 | 🌐 Rust | 📅 2026-09-14 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,264 | 🐛 78 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,268 | 🐛 20 | 🌐 Shell | 📅 2026-09-07 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,507 | 🐛 127 | 🌐 Rust | 📅 2026-09-11 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,431 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,964 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,128 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,100 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - A lightweight TUI app to view and query CSV files.
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,005 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,718 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,125 | 🐛 131 | 🌐 Rust | 📅 2026-09-13 - TUI for the Taskwarrior command-line task manager.
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,762 | 🐛 14 | 🌐 Rust | 📅 2026-09-07 - Manage your GnuPG keys with ease!.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,693 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,649 | 🐛 67 | 🌐 Rust | 📅 2026-09-13 - A fast, keyboard-driven terminal UI for todo.txt.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,594 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,272 | 🐛 34 | 🌐 Rust | 📅 2026-09-10 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,003 | 🐛 3 | 🌐 Rust | 📅 2026-09-12 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 781 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 606 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 550 | 🐛 21 | 🌐 Rust | 📅 2026-09-12 - Markdown renderer in the terminal.
* [rucola](https://github.com/Linus-Mussmaecher/rucola) ⭐ 537 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 - Terminal-based markdown note manager.
* [otree](https://github.com/fioncat/otree) ⭐ 516 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - A command line tool to view objects (JSON/YAML/TOML) in TUI tree widget.
* [models](https://github.com/arimxyer/models) ⭐ 507 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 422 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 326 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 304 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
* [exabind](https://github.com/junkdog/exabind) ⭐ 295 | 🐛 0 | 🌐 Rust | 📅 2026-03-29 - An animated TUI for viewing KDE shortcuts.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 294 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 292 | 🐛 45 | 🌐 Rust | 📅 2026-09-10 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [wiper](https://github.com/ikebastuz/wiper) ⭐ 249 | 🐛 12 | 🌐 Rust | 📅 2025-11-14 - Disk space analyzer and cleanup tool.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 236 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - Fuzzy picker (FZF reboot).
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 216 | 🐛 18 | 🌐 Rust | 📅 2026-09-13 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 139 | 🐛 18 | 🌐 Rust | 📅 2026-09-14 - Task Aggregator TUI for N providers.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 77 | 🐛 9 | 🌐 Rust | 📅 2026-09-13 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
* [ttypr](https://github.com/hotellogical05/ttypr) ⭐ 76 | 🐛 0 | 🌐 Rust | 📅 2026-03-21 - Terminal typing practice.
* [visualvault](https://github.com/mikeleppane/visualvault) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - A TUI for organizing media files.
...
* [dead-ringer](https://github.com/ztroop/dead-ringer) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-03-01 - Binary diff tool for Hex/ASCII analysis.
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 36 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [absorb](https://github.com/kloki/absorb) ⭐ 20 | 🐛 0 | 🌐 Rust | 📅 2026-04-11 - Quickly read a file without moving your eyes.
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 19 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A TUI calendar with Google Calendar sync and DAG-linked events.
...
* [sprout](https://github.com/kb019/sprout) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - A terminal habit tracker with GitHub-style activity heatmap, streak tracking and goal management.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 4 | 🐛 15 | 🌐 Rust | 📅 2026-09-14 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,485 | 🐛 47 | 🌐 Rust | 📅 2026-09-12 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,279 | 🐛 126 | 🌐 Rust | 📅 2026-09-14 - A matrix chat client with vim keybindings.
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,011 | 🐛 19 | 🌐 Rust | 📅 2026-09-14 - A TUI for Telegram written in Rust.
* [termchat](https://github.com/lemunozm/termchat) ⭐ 589 | 🐛 7 | 🌐 Rust | 📅 2023-11-27 - Terminal chat through the LAN with video streaming and file transfer.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 30 | 🌐 Rust | 📅 2026-09-12 - A TUI client for Nostr.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,019 | 🐛 106 | 🌐 Rust | 📅 2026-09-13 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,257 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 13 | 🌐 Rust | 📅 2026-09-14 - Hackable, minimal, and fast TUI file explorer.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,052 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Cross-platform monitoring tool for system stats.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,945 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux Kernel Manager and Activity Monitor.
* [bpftop](https://github.com/Netflix/bpftop) ⭐ 2,705 | 🐛 5 | 🌐 C | 📅 2026-09-01 - Dynamic real-time view of running eBPF programs.
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,534 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast dashboard for Kubernetes.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,322 | 🐛 54 | 🌐 Rust | 📅 2026-09-10 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,879 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,839 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,560 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 797 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 687 | 🐛 9 | 🌐 Rust | 📅 2026-09-14 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 416 | 🐛 4 | 🌐 Rust | 📅 2026-09-12 - Single-host, read-only disk diagnostics TUI.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 12 | 🌐 Rust | 📅 2026-09-12 - TUI for real-time monitoring of Kubernetes resources.
...
* [pumas](https://github.com/graelo/pumas) ⭐ 220 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - Power Usage Monitor for Apple Silicon.
...
* [mirro-rs](https://github.com/rtkay123/mirro-rs) ⭐ 117 | 🐛 24 | 🌐 Rust | 📅 2026-09-08 - An Arch Linux mirrorlist manager with a TUI.
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 117 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 106 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A terminal-based tool for browsing Kubernetes resources.
* [quokka](https://github.com/dutradotdev/quokka) ⭐ 102 | 🐛 2 | 🌐 Rust | 📅 2026-07-27 - A TUI to inspect and tidy a USB-connected iPhone from macOS: storage, apps, media, syslog viewer.
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 85 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [napwatch](https://github.com/Tuguberk/napwatch) ⭐ 72 | 🐛 0 | 🌐 Rust | 📅 2026-07-19 - Diagnoses and controls macOS power/battery behavior: dark wakes, Power Nap, live drain rate, and per-process power draw.
...
* [pacman-utils](https://github.com/ankur3-101106/pacman-utils) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A TUI for pacman, works on Arch-based Distros.
...
* [mxmon](https://github.com/yusufmo1/mxmon) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-07-25 - Sudoless Apple Silicon monitor with per-process watts, a live chassis heat map, and a JSON contract for scripts and agents.

### 📟 Embedded

* [Tuitar](https://github.com/orhun/tuitar) ⭐ 530 | 🐛 6 | 🌐 Rust | 📅 2025-12-23 - A portable guitar training tool.
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - A very feature-rich Modbus Client.
* [Mnyaoo32](https://github.com/intuis/mnyaoo32) ⭐ 35 | 🐛 1 | 🌐 Rust | 📅 2025-05-10 - An eccentric way to consume IRC messages using ESP32.

### 🌌 Other

* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,976 | 🐛 14 | 🌐 Rust | 📅 2026-09-14 - A TUI screensaver that visualizes Git commit history in your terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,752 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
...
* [tgv](https://github.com/zeqianli/tgv) ⭐ 483 | 🐛 13 | 🌐 Rust | 📅 2026-09-07 - Explore human genomes in the terminal.
* [cotp](https://github.com/replydev/cotp) ⭐ 385 | 🐛 7 | 🌐 Rust | 📅 2026-09-09 - Command-line TOTP/HOTP authenticator app.
...
* [tenki](https://github.com/ckaznable/tenki) ⭐ 170 | 🐛 0 | 🌐 Rust | 📅 2026-07-23 - A tty-clock with weather effect.
...
* [sigye](https://github.com/am2rican5/sigye) ⭐ 128 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
...
* [confetty\_rs](https://github.com/Handfish/confetty_rs) ⭐ 89 | 🐛 1 | 🌐 Rust | 📅 2024-02-08 - Particle system (fireworks, stars) rendered in the terminal.
...
* [seqsizzle](https://github.com/ChangqingW/SeqSizzle) ⭐ 27 | 🐛 1 | 🌐 Rust | 📅 2026-08-04 - A pager for viewing FASTQ files with fuzzy matching and coloring.
