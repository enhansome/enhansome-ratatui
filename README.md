...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,278 | 🐛 234 | 🌐 Rust | 📅 2026-08-19
...
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,313 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 - An embedded-graphics backend for Ratatui.
...
* [ratatui-kit](https://github.com/yexiyue/ratatui-kit) ⭐ 39 | 🐛 0 | 🌐 Rust | 📅 2026-07-16 - A React-style component framework for Ratatui with hooks, routing, async state, input layers, and reusable components.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,485 | 🐛 66 | 🌐 Rust | 📅 2026-08-19 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,407 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,773 | 🐛 298 | 🌐 Rust | 📅 2026-08-19 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,281 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - A database management TUI for Postgres.
...
* [serie](https://github.com/lusingander/serie) ⭐ 2,036 | 🐛 24 | 🌐 Rust | 📅 2026-07-19 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,797 | 🐛 102 | 🌐 Rust | 📅 2026-08-19 - An AI coding agent.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 901 | 🐛 11 | 🌐 Rust | 📅 2026-08-18 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 858 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 810 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 520 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 448 | 🐛 15 | 🌐 Rust | 📅 2026-08-19 - Live pixel-art office for AI coding agents.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 213 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 203 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [claudectl](https://github.com/mercurialsolo/claudectl) ⭐ 197 | 🐛 57 | 🌐 Rust | 📅 2026-07-10 - Mission control for multiple Claude Code sessions with live dashboard, cost tracking, and budget enforcement.
...
* [opencode stats](https://github.com/Cateds/opencode-stats) ⭐ 62 | 🐛 1 | 🌐 Rust | 📅 2026-08-04 - A terminal dashboard for OpenCode usage statistics and cost breakdowns.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 46 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 7 | 🐛 4 | 🌐 Rust | 📅 2026-08-18 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,152 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Terminal-based Chess game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,307 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,092 | 🐛 163 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,236 | 🐛 27 | 🌐 Rust | 📅 2026-08-19 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,207 | 🐛 9 | 🌐 Rust | 📅 2026-08-19 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
...
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 355 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - A lightweight, customizable TUI music player for local files.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 184 | 🐛 9 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 88,707 | 🐛 1,081 | 🌐 Dart | 📅 2026-08-19
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,408 | 🐛 2,520 | 🌐 Rust | 📅 2026-08-18 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,627 | 🐛 51 | 🌐 Rust | 📅 2026-08-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,904 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,499 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,501 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - Network diagnostic tool.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,051 | 🐛 7 | 🌐 Rust | 📅 2026-07-29 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,000 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,324 | 🐛 400 | 🌐 Rust | 📅 2026-08-19 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,182 | 🐛 81 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [xan](https://github.com/medialab/xan) ⭐ 4,474 | 🐛 121 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,390 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,935 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,575 | 🐛 53 | 🌐 Rust | 📅 2026-08-18 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,059 | 🐛 26 | 🌐 Rust | 📅 2026-08-19 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 773 | 🐛 24 | 🌐 Rust | 📅 2026-08-16 - Journaling/Notes-taking terminal-based app.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 71 | 🐛 9 | 🌐 Rust | 📅 2026-08-18 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 54 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,262 | 🐛 170 | 🌐 Rust | 📅 2026-08-18 - A matrix chat client with vim keybindings.
* [concord](https://github.com/chojs23/concord) ⭐ 1,239 | 🐛 40 | 🌐 Rust | 📅 2026-08-19 - A TUI client for Discord.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,146 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,202 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,814 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 706 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 97 | 🐛 0 | 🌐 Rust | 📅 2026-08-17 - A terminal-based tool for browsing Kubernetes resources.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 39 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A very feature-rich Modbus Client.
...
* [sigye](https://github.com/am2rican5/sigye) ⭐ 121 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
* [Inertia](https://github.com/aclfe/inertia) ⭐ 111 | 🐛 1 | 🌐 Rust | 📅 2026-07-19 - A 3D physics simulator in your terminal.
* [suzui-rs](https://github.com/thatdevsherry/suzui-rs) ⭐ 106 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - Suzuki pre-obd2 engine data viewer.
