...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,474 | 🐛 223 | 🌐 Rust | 📅 2026-09-01
...
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,322 | 🐛 22 | 🌐 Rust | 📅 2026-09-01 - An embedded-graphics backend for Ratatui.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 39 | 🐛 11 | 🌐 Rust | 📅 2026-08-27 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 43 | 🐛 2 | 🌐 Rust | 📅 2026-08-31 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [jatatui](https://github.com/oyvindberg/jatatui) ⭐ 284 | 🐛 1 | 🌐 Java | 📅 2026-08-22 - A Java port of ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,872 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,454 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,850 | 🐛 299 | 🌐 Rust | 📅 2026-09-01 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,712 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,315 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,310 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,906 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,072 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,887 | 🐛 165 | 🌐 Rust | 📅 2026-09-02 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,766 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,375 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,316 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 918 | 🐛 17 | 🌐 Rust | 📅 2026-09-01 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 827 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 525 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 464 | 🐛 10 | 🌐 Rust | 📅 2026-09-02 - Live pixel-art office for AI coding agents.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 273 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [giff](https://github.com/bahdotsh/giff) ⭐ 272 | 🐛 8 | 🌐 Rust | 📅 2026-04-23 - A TUI for Git diffs with interactive rebase support.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 272 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [deadbranch](https://github.com/armgabrielyan/deadbranch) ⭐ 229 | 🐛 2 | 🌐 Rust | 📅 2026-03-30 - A TUI for cleaning stale Git branches safely.
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 229 | 🐛 6 | 🌐 Rust | 📅 2026-08-30 - Real-time terminal file diff monitoring TUI.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 222 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 20 | 🌐 Rust | 📅 2026-09-01 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 89 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 67 | 🐛 3 | 🌐 Rust | 📅 2026-09-02 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [hedos](https://github.com/theiskaa/hedos) ⭐ 9 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 3 | 🌐 Rust | 📅 2026-09-02 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 11 | 🌐 Rust | 📅 2026-09-01 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - A simple idle farming game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,346 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,162 | 🐛 174 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,346 | 🐛 8 | 🌐 Rust | 📅 2026-08-31 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,297 | 🐛 31 | 🌐 Rust | 📅 2026-09-01 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,119 | 🐛 45 | 📅 2026-08-30 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [ytui-music](https://github.com/sudipghimire533/ytui-music) ⭐ 774 | 🐛 37 | 🌐 Rust | 📅 2025-03-03 - Listen to music from YouTube in the terminal.
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 762 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 708 | 🐛 13 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,907 | 🐛 1,101 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,507 | 🐛 2,513 | 🌐 Rust | 📅 2026-09-01 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,669 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,945 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,521 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,775 | 🐛 80 | 🌐 Rust | 📅 2026-09-01 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,983 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,064 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,824 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,572 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,834 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,131 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 51 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
* [ytunnel](https://github.com/yetidevworks/ytunnel) ⭐ 50 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - A TUI-first CLI for managing Cloudflare Tunnels with custom domains.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,495 | 🐛 420 | 🌐 Rust | 📅 2026-09-02 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,230 | 🐛 83 | 🌐 Rust | 📅 2026-09-01 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [xan](https://github.com/medialab/xan) ⭐ 4,488 | 🐛 127 | 🌐 Rust | 📅 2026-09-01 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,411 | 🐛 38 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,951 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,124 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,118 | 🐛 132 | 🌐 Rust | 📅 2026-08-30 - TUI for the Taskwarrior command-line task manager.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,594 | 🐛 60 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,592 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,095 | 🐛 25 | 🌐 Rust | 📅 2026-09-01 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 969 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 777 | 🐛 25 | 🌐 Rust | 📅 2026-09-01 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 602 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 542 | 🐛 22 | 🌐 Rust | 📅 2026-09-01 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 416 | 🐛 11 | 🌐 Rust | 📅 2026-09-02 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 393 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [timr-tui](https://github.com/sectore/timr-tui) ⭐ 371 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - TUI to organize your time: Pomodoro, Countdown, Timer, Event.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 294 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [neura-hustle-tracker](https://github.com/adolfousier/neura-hustle-tracker) ⭐ 235 | 🐛 0 | 🌐 Rust | 📅 2026-03-16 - A privacy-first TUI to track what apps you use and how long you spend on them.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 214 | 🐛 16 | 🌐 Rust | 📅 2026-09-02 - A customizable terminal splash rendered on shell startup or directory updates.
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 165 | 🐛 8 | 🌐 Rust | 📅 2026-09-02 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [comhad](https://github.com/Eoin-McMahon/Comhad) ⭐ 36 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - A ranger-style terminal browser for S3, with previews, background transfers, and non-destructive sync.
...
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A TUI calendar with Google Calendar sync and DAG-linked events.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 0 | 🐛 11 | 🌐 Rust | 📅 2026-09-02 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,300 | 🐛 42 | 🌐 Rust | 📅 2026-09-01 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,273 | 🐛 162 | 🌐 Rust | 📅 2026-09-02 - A matrix chat client with vim keybindings.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,964 | 🐛 105 | 🌐 Rust | 📅 2026-09-02 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,209 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,284 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,858 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,825 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,556 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [purple](https://github.com/erickochen/purple) ⭐ 666 | 🐛 6 | 🌐 Rust | 📅 2026-08-31 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [pumas](https://github.com/graelo/pumas) ⭐ 219 | 🐛 2 | 🌐 Rust | 📅 2026-09-02 - Power Usage Monitor for Apple Silicon.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 103 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A terminal-based tool for browsing Kubernetes resources.
* [quokka](https://github.com/dutradotdev/quokka) ⭐ 94 | 🐛 2 | 🌐 Rust | 📅 2026-07-27 - A TUI to inspect and tidy a USB-connected iPhone from macOS: storage, apps, media, syslog viewer.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 71 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-02 - A minimal serial monitor with plotter TUI.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,951 | 🐛 13 | 🌐 Rust | 📅 2026-08-31 - A TUI screensaver that visualizes Git commit history in your terminal.
...
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,075 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 - Alternative watch command with command history and diffs.
...
* [sigye](https://github.com/am2rican5/sigye) ⭐ 124 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
