...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,273 | 🐛 237 | 🌐 Rust | 📅 2026-08-17
...
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,313 | 🐛 24 | 🌐 Rust | 📅 2026-08-17 - An embedded-graphics backend for Ratatui.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 32 | 🐛 21 | 🌐 Rust | 📅 2026-08-12 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2026-08-14 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [ratatui-code-editor](https://github.com/vipmax/ratatui-code-editor) ⭐ 114 | 🐛 4 | 🌐 Rust | 📅 2026-07-07 - A code editor widget for ratatui, syntax highlighting powered by tree-sitter.
...
* [bevy\_ratatui](https://github.com/joshka/bevy_ratatui) ⭐ 164 | 🐛 9 | 🌐 Rust | 📅 2026-08-18 - A Rust crate to use Ratatui in a Bevy App.
...
* [pyratatui](https://github.com/pyratatui/pyratatui) ⭐ 141 | 🐛 0 | 🌐 Rust | 📅 2026-06-05 - Python bindings to ratatui, powered by Maturin and PyO3.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,478 | 🐛 66 | 🌐 Rust | 📅 2026-08-17 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,405 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,768 | 🐛 296 | 🌐 Rust | 📅 2026-08-18 - Comprehensive Deep Learning framework in Rust.
...
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,296 | 🐛 11 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,854 | 🐛 62 | 🌐 Rust | 📅 2026-08-16 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,037 | 🐛 23 | 🌐 Rust | 📅 2026-07-19 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,790 | 🐛 103 | 🌐 Rust | 📅 2026-08-19 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,742 | 🐛 38 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,372 | 🐛 15 | 🌐 Rust | 📅 2026-07-29 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,298 | 🐛 10 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,188 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 901 | 🐛 9 | 🌐 Rust | 📅 2026-08-18 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 858 | 🐛 21 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 809 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A Semantic Coding Agent.
...
* [patent](https://github.com/r14dd/patent) ⭐ 520 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 448 | 🐛 11 | 🌐 Rust | 📅 2026-08-19 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 251 | 🐛 5 | 🌐 Rust | 📅 2026-08-17 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 214 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 202 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [claudectl](https://github.com/mercurialsolo/claudectl) ⭐ 196 | 🐛 57 | 🌐 Rust | 📅 2026-07-10 - Mission control for multiple Claude Code sessions with live dashboard, cost tracking, and budget enforcement.
...
* [opencode stats](https://github.com/Cateds/opencode-stats) ⭐ 61 | 🐛 1 | 🌐 Rust | 📅 2026-08-04 - A terminal dashboard for OpenCode usage statistics and cost breakdowns.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 46 | 🐛 6 | 🌐 Rust | 📅 2026-08-18 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [blippy](https://github.com/AksharP5/blippy) ⭐ 25 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A keyboard-first TUI for GitHub issues and pull requests.
* [TaskUI](https://github.com/thmshmm/taskui) ⭐ 24 | 🐛 1 | 🌐 Rust | 📅 2024-08-11 - Simple Terminal UI for Task / taskfile.dev.
* [amtr](https://github.com/arian-shamaei/anthropometer) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A btop-style TUI that renders a Claude Code session's live context window as a memory map, with tool and file traffic, cache economics, and a compiled PDF report.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A local dashboard for Codex and Claude Code.
...
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 6 | 🌐 Rust | 📅 2026-08-18 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 6 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
* [VLE](https://github.com/tuffy/vle) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - A lightweight text editor.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,151 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 - Terminal-based Chess game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,308 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,088 | 🐛 163 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,234 | 🐛 27 | 🌐 Rust | 📅 2026-08-18 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,207 | 🐛 8 | 🌐 Rust | 📅 2026-08-16 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,098 | 🐛 48 | 🌐 Rust | 📅 2026-08-08 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 918 | 🐛 22 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 695 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 183 | 🐛 9 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [ytsub](https://github.com/sarowish/ytsub) ⭐ 89 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A subscriptions only TUI YouTube client.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 88,673 | 🐛 1,079 | 🌐 Dart | 📅 2026-08-19
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,397 | 🐛 2,519 | 🌐 Rust | 📅 2026-08-18 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,626 | 🐛 51 | 🌐 Rust | 📅 2026-08-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,905 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,498 | 🐛 59 | 🌐 Rust | 📅 2026-08-02 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,499 | 🐛 79 | 🌐 Rust | 📅 2026-08-13 - Network diagnostic tool.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,051 | 🐛 6 | 🌐 Rust | 📅 2026-07-29 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 997 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 70 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 38 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,314 | 🐛 400 | 🌐 Rust | 📅 2026-08-19 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,181 | 🐛 81 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,219 | 🐛 11 | 🌐 Shell | 📅 2026-08-17 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,473 | 🐛 121 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,389 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,934 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,116 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,697 | 🐛 67 | 🌐 Rust | 📅 2026-07-20 - Run multiple commands in parallel and shows output of each command separately.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,575 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,058 | 🐛 25 | 🌐 Rust | 📅 2026-08-18 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 936 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 772 | 🐛 24 | 🌐 Rust | 📅 2026-08-16 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 597 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 532 | 🐛 19 | 🌐 Rust | 📅 2026-08-18 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 493 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 293 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 284 | 🐛 3 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [wiper](https://github.com/ikebastuz/wiper) ⭐ 247 | 🐛 12 | 🌐 Rust | 📅 2025-11-14 - Disk space analyzer and cleanup tool.
* [sheetsui](https://github.com/zaphar/sheetsui) ⭐ 245 | 🐛 3 | 🌐 Rust | 📅 2026-03-03 - A terminal based spreadsheet application.
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 238 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - Fuzzy picker (FZF reboot).
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 156 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [codemark](https://github.com/DanielCardonaRojas/codemark) ⭐ 120 | 🐛 8 | 🌐 Rust | 📅 2026-08-18 - A semantic code bookmarking system for humans and agents.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 45 | 🐛 2 | 🌐 Rust | 📅 2026-08-17 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [flerp](https://github.com/Huseynteymurzade28/flerp) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2026-08-17 - A TUI for exploring and analyzing text files, PDFs and images.
...
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,261 | 🐛 170 | 🌐 Rust | 📅 2026-08-18 - A matrix chat client with vim keybindings.
* [concord](https://github.com/chojs23/concord) ⭐ 1,233 | 🐛 39 | 🌐 Rust | 📅 2026-08-17 - A TUI client for Discord.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,906 | 🐛 107 | 🌐 Rust | 📅 2026-08-18 - Cross-platform graphical process/system monitor.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,043 | 🐛 41 | 🌐 Rust | 📅 2026-07-13 - Cross-platform monitoring tool for system stats.
* [kmon](https://github.com/orhun/kmon) ⭐ 2,933 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 - Linux Kernel Manager and Activity Monitor.
* [bpftop](https://github.com/Netflix/bpftop) ⭐ 2,700 | 🐛 5 | 🌐 C | 📅 2026-08-01 - Dynamic real-time view of running eBPF programs.
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,520 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - A simple and fast dashboard for Kubernetes.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,201 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,812 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,809 | 🐛 24 | 🌐 Rust | 📅 2026-07-24 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,547 | 🐛 16 | 🌐 Rust | 📅 2026-08-18 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 705 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 423 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 103 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
* [b4n](https://github.com/fioletoven/b4n) ⭐ 96 | 🐛 0 | 🌐 Rust | 📅 2026-08-17 - A terminal-based tool for browsing Kubernetes resources.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 61 | 🐛 2 | 🌐 Rust | 📅 2026-08-13 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [Tuitar](https://github.com/orhun/tuitar) ⭐ 524 | 🐛 6 | 🌐 Rust | 📅 2025-12-23 - A portable guitar training tool.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 39 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A very feature-rich Modbus Client.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,738 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,345 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
...
* [hncli](https://github.com/pierreyoda/hncli) ⭐ 49 | 🐛 2 | 🌐 Rust | 📅 2026-08-17 - Hacker News read-only TUI.
