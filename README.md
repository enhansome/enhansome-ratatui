...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,670 | 🐛 215 | 🌐 Rust | 📅 2026-09-19
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,953 | 🐛 322 | 🌐 Rust | 📅 2026-09-19 - Comprehensive Deep Learning framework in Rust.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 91 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [pyratatui](https://github.com/programmersd21/pyratatui) ⭐ 158 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - Python bindings for Ratatui powered by PyO3, featuring async support, many widgets, and advanced terminal animations via TachyonFX.
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 116 | 🐛 0 | 🌐 Elixir | 📅 2026-09-18 - Elixir bindings for ratatui.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,509 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,319 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,916 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,107 | 🐛 25 | 🌐 Rust | 📅 2026-09-19 - A rich Git commit graph in your terminal.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 136 | 🐛 15 | 🌐 Rust | 📅 2026-09-19 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 3 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - Real-time terminal file diff monitoring TUI.
...
* [rgx](https://github.com/brevity1swos/rgx) ⭐ 237 | 🐛 0 | 🌐 Rust | 📅 2026-07-07 - A terminal regex debugger with real-time matching, 3 engines, capture group highlighting, replace mode, and plain-English explanations.
...
* [lingora-tui](https://github.com/nigeleke/lingora) ⭐ 35 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - Browse, compare and validate Fluent i18n files.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 602 | 🐛 54 | 🌐 Rust | 📅 2026-09-18 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 308 | 🐛 8 | 🌐 Rust | 📅 2026-09-19 - Fast, driverless, Vim-first database TUI with safe editing and ER diagrams.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,302 | 🐛 59 | 🌐 Rust | 📅 2026-09-20 - An open-source desktop workspace for general-purpose AI agents.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,790 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 939 | 🐛 14 | 🌐 Rust | 📅 2026-09-20 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 851 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - An open-source Rust coding agent for the terminal.
...
* [patent](https://github.com/r14dd/patent) ⭐ 526 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - A prior-art search for developer-tool ideas with an AI-generated verdict.
* [models](https://github.com/reyamira/models) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 481 | 🐛 10 | 🌐 Rust | 📅 2026-09-20 - Live pixel-art office for AI coding agents.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 75 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 72 | 🐛 10 | 🌐 Rust | 📅 2026-09-19 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 35 | 🐛 7 | 🌐 Rust | 📅 2026-09-19 - A terminal-native prompt composer for developers working with coding agents.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,305 | 🐛 62 | 🌐 Rust | 📅 2026-09-19 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,516 | 🐛 122 | 🌐 Rust | 📅 2026-09-18 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,433 | 🐛 37 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,974 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,758 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,745 | 🐛 412 | 🌐 Rust | 📅 2026-09-19 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,281 | 🐛 78 | 🌐 Rust | 📅 2026-09-19 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,287 | 🐛 35 | 🌐 Rust | 📅 2026-09-17 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 426 | 🐛 10 | 🌐 Rust | 📅 2026-09-18 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 215 | 🐛 13 | 🌐 Rust | 📅 2026-09-19 - A customizable terminal splash rendered on shell startup or directory updates.
* [snipt](https://github.com/snipt/snipt) ⭐ 149 | 🐛 5 | 🌐 Rust | 📅 2026-04-02 - A text snippet expansion tool with a TUI for managing snippets.
* [sigye](https://github.com/am2rican5/sigye) ⭐ 130 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,685 | 🐛 41 | 🌐 Rust | 📅 2026-09-18 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,981 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,944 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,038 | 🐛 32 | 🌐 Rust | 📅 2026-09-18 - A cross-platform network monitoring tool with deep packet inspection.
* [impala](https://github.com/pythops/impala) ⭐ 2,857 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi on Linux.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,184 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 731 | 🐛 12 | 🌐 Rust | 📅 2026-08-09 - A terminal client for subscribing to and publishing messages over MQTT.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 258 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 111 | 🐛 11 | 🌐 Rust | 📅 2026-09-19 - A terminal monitor for live video streams with real-time health checks and metrics.
...
* [FlowLens](https://github.com/power4j/flowlens) ⭐ 11 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A cross-platform network traffic analyzer with process, IP, and outbound-domain attribution.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 92,174 | 🐛 1,128 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,091 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [slumber](https://github.com/LucasPickering/slumber) ⭐ 1,228 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - Terminal-based HTTP/REST client.
* [purple](https://github.com/erickochen/purple) ⭐ 699 | 🐛 4 | 🌐 Rust | 📅 2026-09-17 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 697 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa.si tui tool for browsing and downloading torrents.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,532 | 🐛 44 | 🌐 Rust | 📅 2026-09-19 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,287 | 🐛 113 | 🌐 Rust | 📅 2026-09-20 - A matrix chat client with vim keybindings.
...
* [tincan](https://github.com/bilalyazicioglu/tincan-cli) ⭐ 8 | 🐛 48 | 🌐 Rust | 📅 2026-09-19 - Peer-to-peer voice and text chat with no server.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,590 | 🐛 2,486 | 🌐 Rust | 📅 2026-09-18 - A high-performance observability data pipeline.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 459 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 118 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,848 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,563 | 🐛 2 | 🌐 Rust | 📅 2026-09-20 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,281 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,332 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,059 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast, simple TUI for interacting with systemd services and their logs.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 854 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,889 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - A minimal serial monitor with plotter TUI.
...
* [quokka](https://github.com/dutradotdev/quokka) ⭐ 104 | 🐛 2 | 🌐 Rust | 📅 2026-07-27 - A TUI to inspect and tidy a USB-connected iPhone from macOS: storage, apps, media, syslog viewer.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - A terminal client for Modbus industrial devices.
...
* [cotp](https://github.com/replydev/cotp) ⭐ 385 | 🐛 7 | 🌐 Rust | 📅 2026-09-18 - An encrypted command-line authenticator for time- and counter-based one-time passwords.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - TUI for the Taskwarrior command-line task manager.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,684 | 🐛 73 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven terminal UI for todo.txt.
...
* [kanban](https://github.com/kanban-rs/kanban) ⭐ 169 | 🐛 11 | 🌐 Rust | 📅 2026-09-15 - TUI kanban board for projects management with sprint tracking and task prioritization.
* [Jirust](https://github.com/Code-Militia/jirust) ⭐ 160 | 🐛 6 | 🌐 Rust | 📅 2024-05-29 - A Jira TUI.
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 142 | 🐛 18 | 🌐 Rust | 📅 2026-09-19 - A terminal task manager that aggregates tasks from multiple providers.
...
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,695 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,009 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 432 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 296 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 11 | 🌐 Rust | 📅 2026-09-18 - A TUI feed viewer.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 92 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,226 | 🐛 155 | 🌐 Rust | 📅 2026-09-19 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,369 | 🐛 34 | 🌐 Rust | 📅 2026-09-19 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 233 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,113 | 🐛 10 | 🌐 Rust | 📅 2026-09-18 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
...
* [Absotui](https://github.com/pdwaldrop/absotui) ⭐ 21 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - A fast, keyboard-driven TUI client for Audiobookshelf (self-hosted audiobook/podcast server).
...
* [tracker](https://github.com/ShenMian/tracker) ⭐ 326 | 🐛 1 | 🌐 Rust | 📅 2026-07-05 - A terminal-based real-time satellite tracking and orbit prediction application.
