...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,602 | 🐛 221 | 🌐 Rust | 📅 2026-09-14
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,453 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,327 | 🐛 24 | 🌐 Rust | 📅 2026-09-14 - An embedded-graphics backend for Ratatui.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 116 | 🐛 0 | 🌐 Elixir | 📅 2026-09-14 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,193 | 🐛 65 | 🌐 Rust | 📅 2026-09-12 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,492 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,918 | 🐛 309 | 🌐 Rust | 📅 2026-09-14 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,726 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
...
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,130 | 🐛 82 | 🌐 Rust | 📅 2026-09-15 - An AI coding agent.
* [serie](https://github.com/lusingander/serie) ⭐ 2,101 | 🐛 25 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,784 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,210 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 935 | 🐛 4 | 🌐 Rust | 📅 2026-09-15 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 844 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A Semantic Coding Agent.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 601 | 🐛 58 | 🌐 Rust | 📅 2026-09-05 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [patent](https://github.com/r14dd/patent) ⭐ 526 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 477 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - Live pixel-art office for AI coding agents.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 229 | 🐛 16 | 🌐 Rust | 📅 2026-09-08 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 93 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 75 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 68 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 64 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
* [ygrep](https://github.com/yetidevworks/ygrep) ⭐ 58 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 - A fast, local, indexed code search tool with a TUI, optimized for AI coding assistants and powered by Tantivy full-text indexing.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 29 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - A terminal-native prompt composer for developers working with coding agents.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 22 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A local dashboard for Codex and Claude Code.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 8 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 5 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,175 | 🐛 30 | 🌐 Rust | 📅 2026-09-14 - Terminal-based Chess game.
* [Rebels in the sky](https://github.com/ricott1/rebels-in-the-sky) ⭐ 739 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - P2P terminal game about spacepirates playing basketball across the galaxy.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,212 | 🐛 153 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,974 | 🐛 13 | 🌐 Rust | 📅 2026-09-14 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,351 | 🐛 36 | 🌐 Rust | 📅 2026-09-15 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,142 | 🐛 46 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 769 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 719 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 225 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 48 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - Deezer music TUI with included background player.
...
* [Youta](https://github.com/vitaly-zdanevich/youta) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - An audio player for YouTube, Yandex Music, podcasts, audiobooks, radio, and local files.
* [ytmusic-tui](https://github.com/WakaTaira/ytmusic-tui) ⭐ 6 | 🐛 11 | 🌐 Rust | 📅 2026-06-19 - TUI client for YouTube Music with vim-style keybindings, spotify-player-inspired navigation, and MPRIS2 support.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 91,503 | 🐛 1,119 | 🌐 Dart | 📅 2026-09-14
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,556 | 🐛 2,487 | 🌐 Rust | 📅 2026-09-15 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,677 | 🐛 40 | 🌐 Rust | 📅 2026-09-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,968 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,547 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,924 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,022 | 🐛 32 | 🌐 Rust | 📅 2026-09-14 - A cross-platform network monitoring tool with deep packet inspection.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,847 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,157 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 727 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT client for subscribing or publishing to topics.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 105 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,625 | 🐛 413 | 🌐 Rust | 📅 2026-09-15 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,267 | 🐛 78 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,280 | 🐛 20 | 🌐 Shell | 📅 2026-09-14 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,509 | 🐛 127 | 🌐 Rust | 📅 2026-09-11 - A terminal tool for processing CSV files.
...
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,720 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,126 | 🐛 131 | 🌐 Rust | 📅 2026-09-13 - TUI for the Taskwarrior command-line task manager.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,275 | 🐛 34 | 🌐 Rust | 📅 2026-09-14 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,005 | 🐛 3 | 🌐 Rust | 📅 2026-09-12 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [models](https://github.com/arimxyer/models) ⭐ 507 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 328 | 🐛 10 | 🌐 Rust | 📅 2026-09-10 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
* [rusty-krab-manager](https://github.com/aryakaul/rusty-krab-manager) ⭐ 328 | 🐛 11 | 🌐 Rust | 📅 2026-08-30 - Rime management TUI in Rust.
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 306 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
* [exabind](https://github.com/junkdog/exabind) ⭐ 295 | 🐛 0 | 🌐 Rust | 📅 2026-03-29 - An animated TUI for viewing KDE shortcuts.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 294 | 🐛 5 | 🌐 Rust | 📅 2026-08-12 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [passepartui](https://github.com/kardwen/passepartui) ⭐ 129 | 🐛 3 | 🌐 Rust | 📅 2025-05-07 - A TUI for pass.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 88 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [visualvault](https://github.com/mikeleppane/visualvault) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - A TUI for organizing media files.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 47 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 37 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [sprout](https://github.com/kb019/sprout) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - A terminal habit tracker with GitHub-style activity heatmap, streak tracking and goal management.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,498 | 🐛 48 | 🌐 Rust | 📅 2026-09-12 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,280 | 🐛 127 | 🌐 Rust | 📅 2026-09-14 - A matrix chat client with vim keybindings.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 71 | 🐛 33 | 🌐 Rust | 📅 2026-09-14 - A TUI client for Nostr.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,022 | 🐛 105 | 🌐 Rust | 📅 2026-09-15 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,263 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,823 | 🐛 14 | 🌐 Rust | 📅 2026-09-14 - Hackable, minimal, and fast TUI file explorer.
...
* [bpftop](https://github.com/Netflix/bpftop) ⭐ 2,706 | 🐛 5 | 🌐 C | 📅 2026-09-01 - Dynamic real-time view of running eBPF programs.
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,534 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast dashboard for Kubernetes.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,324 | 🐛 54 | 🌐 Rust | 📅 2026-09-10 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,882 | 🐛 16 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,561 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 804 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 688 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 432 | 🐛 2 | 🌐 Rust | 📅 2026-09-14 - Single-host, read-only disk diagnostics TUI.
...
* [mirro-rs](https://github.com/rtkay123/mirro-rs) ⭐ 117 | 🐛 24 | 🌐 Rust | 📅 2026-09-14 - An Arch Linux mirrorlist manager with a TUI.
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 117 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 86 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - A very feature-rich Modbus Client.
