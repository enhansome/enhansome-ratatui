...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,445 | 🐛 220 | 🌐 Rust | 📅 2026-08-29
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,434 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,319 | 🐛 22 | 🌐 Rust | 📅 2026-08-24 - An embedded-graphics backend for Ratatui.
...
* [ratatui-splash-screen](https://github.com/orhun/ratatui-splash-screen) ⭐ 151 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - A widget to turn any image to a splash screen.
...
* [tachyonfx](https://github.com/junkdog/tachyonfx) ⭐ 1,291 | 🐛 7 | 🌐 Rust | 📅 2026-07-19 - A shader-like effects library for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,799 | 🐛 72 | 🌐 Rust | 📅 2026-08-26 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,446 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,834 | 🐛 307 | 🌐 Rust | 📅 2026-08-29 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,707 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,903 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,065 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,867 | 🐛 184 | 🌐 Rust | 📅 2026-08-30 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,759 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,375 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,313 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,201 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 916 | 🐛 16 | 🌐 Rust | 📅 2026-08-29 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 826 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - A Semantic Coding Agent.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 526 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
* [patent](https://github.com/r14dd/patent) ⭐ 524 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 460 | 🐛 13 | 🌐 Rust | 📅 2026-08-29 - Live pixel-art office for AI coding agents.
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 437 | 🐛 25 | 🌐 Rust | 📅 2026-08-29 - Tracer for execve{,at} and pre-exec behavior, launcher for debuggers.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 261 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 259 | 🐛 5 | 🌐 Rust | 📅 2026-08-30 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 228 | 🐛 5 | 🌐 Rust | 📅 2026-08-23 - Real-time terminal file diff monitoring TUI.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 19 | 🌐 Rust | 📅 2026-08-29 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 88 | 🐛 1 | 🌐 Rust | 📅 2026-07-27 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-08-30 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 - A local dashboard for Codex and Claude Code.
...
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 5 | 🐛 3 | 🌐 Rust | 📅 2026-08-30 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,334 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,154 | 🐛 173 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,324 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,278 | 🐛 36 | 🌐 Rust | 📅 2026-08-29 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,108 | 🐛 47 | 📅 2026-08-28 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 926 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 761 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing all your Servarrs.
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 705 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
...
* [rs-pug](https://github.com/JustRoccat/rs-pug) ⭐ 67 | 🐛 0 | 🌐 Rust | 📅 2026-08-20 - A Neovim-inspired asynchronous music player with a reactive audio visualizer.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,710 | 🐛 1,103 | 🌐 Dart | 📅 2026-08-28
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,487 | 🐛 2,513 | 🌐 Rust | 📅 2026-08-29 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,660 | 🐛 52 | 🌐 Rust | 📅 2026-08-24 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,935 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,517 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,565 | 🐛 78 | 🌐 Rust | 📅 2026-08-27 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,972 | 🐛 16 | 🌐 Rust | 📅 2026-08-29 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,062 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,814 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-08-28 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,826 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,644 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,103 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 31 | 🐛 11 | 🌐 Rust | 📅 2026-08-29 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,462 | 🐛 415 | 🌐 Rust | 📅 2026-08-29 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,223 | 🐛 83 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [xan](https://github.com/medialab/xan) ⭐ 4,485 | 🐛 124 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,410 | 🐛 38 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,947 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,120 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,090 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - A lightweight TUI app to view and query CSV files.
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,981 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,706 | 🐛 67 | 🌐 Rust | 📅 2026-08-29 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,114 | 🐛 132 | 🌐 Rust | 📅 2026-08-30 - TUI for the Taskwarrior command-line task manager.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,592 | 🐛 60 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,084 | 🐛 24 | 🌐 Rust | 📅 2026-08-29 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 953 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 539 | 🐛 19 | 🌐 Rust | 📅 2026-08-18 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 503 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 429 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 415 | 🐛 11 | 🌐 Rust | 📅 2026-08-30 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [jwt-ui](https://github.com/jwt-rs/jwt-ui) ⭐ 349 | 🐛 10 | 🌐 Rust | 📅 2026-05-31 - A command line UI for decoding/encoding JSON Web Tokens.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 293 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 214 | 🐛 13 | 🌐 Rust | 📅 2026-08-29 - A customizable terminal splash rendered on shell startup or directory updates.
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 164 | 🐛 7 | 🌐 Rust | 📅 2026-08-30 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 137 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - Task Aggregator TUI for N providers.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 74 | 🐛 10 | 🌐 Rust | 📅 2026-08-25 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
* [visualvault](https://github.com/mikeleppane/visualvault) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-08-24 - A TUI for organizing media files.
...
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-04-06 - A TUI calendar with Google Calendar sync and DAG-linked events.
...
* [fastcards](https://github.com/indium114/fastcards) ⭐ 10 | 🐛 2 | 🌐 Rust | 📅 2026-08-30 - A CLI spaced-repetition flashcard study tool.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,288 | 🐛 43 | 🌐 Rust | 📅 2026-08-27 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,271 | 🐛 164 | 🌐 Rust | 📅 2026-08-30 - A matrix chat client with vim keybindings.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - TUI for the lobste.rs website.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,949 | 🐛 107 | 🌐 Rust | 📅 2026-08-30 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,189 | 🐛 3 | 🌐 Rust | 📅 2026-08-30 - View disk space usage and delete unwanted data, fast.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,270 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
* [ytop](https://github.com/cjbassi/ytop) ⚠️ Archived - TUI system monitor for Linux.
* [systemctl-tui](https://github.com/rgwood/systemctl-tui) ⭐ 2,043 | 🐛 6 | 🌐 Rust | 📅 2026-07-27 - A fast, simple TUI for interacting with systemd services and their logs.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,853 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,823 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,556 | 🐛 19 | 🌐 Rust | 📅 2026-08-29 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 735 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 662 | 🐛 4 | 🌐 Rust | 📅 2026-08-27 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 351 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 112 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 4 | 🌐 Rust | 📅 2026-08-30 - A minimal serial monitor with plotter TUI.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,944 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 - A TUI screensaver that visualizes Git commit history in your terminal.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,745 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,352 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,074 | 🐛 10 | 🌐 Rust | 📅 2026-08-10 - Alternative watch command with command history and diffs.
