...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,747 | 🐛 210 | 🌐 Rust | 📅 2026-09-25
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,988 | 🐛 211 | 🌐 Rust | 📅 2026-09-26 - Comprehensive Deep Learning framework in Rust.
* [ratzilla](https://github.com/ratatui/ratzilla) ⭐ 1,460 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
...
* [rat-salsa](https://github.com/thscharler/rat-salsa) ⭐ 64 | 🐛 9 | 🌐 Rust | 📅 2026-07-03 - An event-queue for ratatui with tasks, timers, application events, focus handling, dialog windows.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-09-25 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [tachyonfx](https://github.com/ratatui/tachyonfx) ⭐ 1,297 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 - An animation and visual-effects library for Ratatui applications.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,523 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,920 | 🐛 62 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,120 | 🐛 25 | 🌐 Rust | 📅 2026-09-26 - A rich Git commit graph in your terminal.
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,217 | 🐛 45 | 🌐 Rust | 📅 2026-09-24 - A TUI for the Jujutsu version-control system.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 302 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 142 | 🐛 16 | 🌐 Rust | 📅 2026-09-22 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [rootle](https://github.com/rootledev/rootle) ⭐ 5 | 🐛 7 | 🌐 Rust | 📅 2026-09-25 - A modal TUI for browsing GitHub and other source-control services with column views and syntax-highlighted previews.
...
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 858 | 🐛 23 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,562 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - An HTTP load generator with a real-time terminal UI.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,349 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 - A database management TUI for Postgres.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,730 | 🐛 22 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
* [gobang](https://github.com/TaKO8Ki/gobang) ⭐ 3,322 | 🐛 57 | 🌐 Rust | 📅 2023-11-10 - Cross-platform TUI database management tool.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,419 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
...
* [tracexec](https://github.com/kxxt/tracexec) ⭐ 442 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 - A terminal tool for tracing which programs and commands are executed.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,329 | 🐛 71 | 🌐 Rust | 📅 2026-09-25 - An open-source desktop workspace for general-purpose AI agents.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,797 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 944 | 🐛 9 | 🌐 Rust | 📅 2026-09-26 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 854 | 🐛 2 | 🌐 Rust | 📅 2026-09-25 - An open-source Rust coding agent for the terminal.
...
* [models](https://github.com/reyamira/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-26 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 482 | 🐛 9 | 🌐 Rust | 📅 2026-09-25 - Live pixel-art office for AI coding agents.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 240 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A local proxy that compresses large-language-model API requests to reduce token costs, with a dashboard for per-source costs and context usage.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 79 | 🐛 10 | 🌐 Rust | 📅 2026-09-26 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 46 | 🐛 4 | 🌐 Rust | 📅 2026-09-26 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 45 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 41 | 🐛 6 | 🌐 Rust | 📅 2026-09-26 - A terminal-native prompt composer for developers working with coding agents.
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 30 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - A local dashboard for Codex and Claude Code.
...
* [lumen](https://github.com/blackopsrepl/lumen) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - Runs a ratatui app as an agent session and gives a human a live cell-grid view of it.
* [savras](https://github.com/Marijusaj/savras) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2026-09-26 - A side panel that sees every Claude Code session you have running: which are waiting on you, working, or done, with their PRs and context used.
...
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,831 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,527 | 🐛 122 | 🌐 Rust | 📅 2026-09-25 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,446 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,987 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,135 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 553 | 🐛 21 | 🌐 Rust | 📅 2026-09-23 - Markdown renderer in the terminal.
...
* [comhad](https://github.com/Eoin-McMahon/Comhad) ⭐ 36 | 🐛 4 | 🌐 Rust | 📅 2026-09-16 - A ranger-style terminal browser for S3, with previews, background transfers, and non-destructive sync.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 4 | 🐛 18 | 🌐 Rust | 📅 2026-09-25 - A Terminal Markdown editor that stays rendered while you edit.

### 🧰 Terminal Workflow

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,815 | 🐛 389 | 🌐 Rust | 📅 2026-09-26 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,291 | 🐛 80 | 🌐 Rust | 📅 2026-09-23 - A blazingly fast general purpose fuzzy finder for your terminal.
* [dekit](https://github.com/pvolok/dekit) ⭐ 2,728 | 🐛 69 | 🌐 Rust | 📅 2026-09-24 - Run multiple commands in parallel and shows output of each command separately.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,301 | 🐛 35 | 🌐 Rust | 📅 2026-09-21 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 439 | 🐛 12 | 🌐 Rust | 📅 2026-09-26 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [matchmaker](https://github.com/Squirreljetpack/matchmaker) ⭐ 237 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - A fast, configurable fuzzy searcher for terminal data.
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 216 | 🐛 13 | 🌐 Rust | 📅 2026-09-25 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [noble](https://github.com/MertSoylu/noble) ⭐ 1 | 🐛 3 | 🌐 Rust | 📅 2026-09-25 - A HUD terminal workspace with tabs and splits, git projects, system sensors and AI coding quota in one screen.
...
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,988 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,960 | 🐛 84 | 🌐 Rust | 📅 2026-09-26 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,054 | 🐛 33 | 🌐 Rust | 📅 2026-09-26 - A cross-platform network monitoring tool with deep packet inspection.
* [impala](https://github.com/pythops/impala) ⭐ 2,867 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,582 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,864 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,663 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,197 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 260 | 🐛 3 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 92,708 | 🐛 1,136 | 🌐 Dart | 📅 2026-09-24
...
* [purple](https://github.com/erickochen/purple) ⭐ 706 | 🐛 4 | 🌐 Rust | 📅 2026-09-22 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 702 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa.si tui tool for browsing and downloading torrents.
...
* [bunflared](https://github.com/mirkobozzetto/bunflared) ⭐ 3 | 🐛 1 | 🌐 Rust | 📅 2026-09-26 - Share localhost on a temporary public HTTPS link through a Cloudflare quick tunnel, with a live traffic dashboard.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

#### Communications and Social

* [concord](https://github.com/chojs23/concord) ⭐ 1,553 | 🐛 48 | 🌐 Rust | 📅 2026-09-23 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,293 | 🐛 109 | 🌐 Rust | 📅 2026-09-25 - A matrix chat client with vim keybindings.
...
* [tincan](https://github.com/bilalyazicioglu/tincan-cli) ⭐ 43 | 🐛 51 | 🌐 Rust | 📅 2026-09-25 - Peer-to-peer voice and text chat with no server.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-09-25 - TUI for the lobste.rs website.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,616 | 🐛 2,484 | 🌐 Rust | 📅 2026-09-25 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,060 | 🐛 106 | 🌐 Rust | 📅 2026-09-23 - Cross-platform graphical process/system monitor.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 467 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Single-host, read-only disk diagnostics TUI.
...
* [toptop](https://github.com/ur-grue/toptop) ⭐ 17 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - System monitor with a local-inference view: live tokens/sec, GPU compute-vs-bandwidth, VRAM-spill verdicts.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,862 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,563 | 🐛 5 | 🌐 Rust | 📅 2026-09-26 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 396 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - TUI for real-time monitoring of Kubernetes resources.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,298 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - View disk space usage and delete unwanted data, fast.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,298 | 🐛 22 | 🌐 Shell | 📅 2026-09-21 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,356 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 890 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [pacman-utils](https://github.com/ankur3-101106/pacman-utils) ⭐ 17 | 🐛 0 | 🌐 Rust | 📅 2026-09-26 - A keyboard-driven Arch Linux system manager with pacman, AUR, and reflector tools.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,019 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,903 | 🐛 18 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 171 | 🐛 3 | 🌐 Rust | 📅 2026-09-26 - A minimal serial monitor with plotter TUI.
...
* [thinkfan-tui](https://github.com/karjonas/thinkfan-tui) ⭐ 79 | 🐛 1 | 🌐 Rust | 📅 2026-07-29 - A terminal-based Linux application for fan control and temperature monitoring on ThinkPad laptops.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-25 - A terminal client for Modbus industrial devices.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,764 | 🐛 14 | 🌐 Rust | 📅 2026-09-21 - A TUI for managing GnuPG encryption keys.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,131 | 🐛 131 | 🌐 Rust | 📅 2026-09-25 - TUI for the Taskwarrior command-line task manager.
...
* [kanban](https://github.com/kanban-rs/kanban) ⭐ 170 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - TUI kanban board for projects management with sprint tracking and task prioritization.
* [Jirust](https://github.com/Code-Militia/jirust) ⭐ 160 | 🐛 6 | 🌐 Rust | 📅 2024-05-29 - A Jira TUI.
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 142 | 🐛 18 | 🌐 Rust | 📅 2026-09-26 - A terminal task manager that aggregates tasks from multiple providers.
...
* [Rex](https://github.com/TheRustyPickle/Rex) ⭐ 62 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - A TUI for managing Incomes and Expenses.
...
* [hustle-tracker](https://github.com/adolfousier/hustle-tracker) ⭐ 239 | 🐛 0 | 🌐 Rust | 📅 2026-03-16 - A privacy-first TUI to track what apps you use and how long you spend on them.
...
* [sprout](https://github.com/kb019/sprout) ⭐ 37 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A terminal habit tracker with GitHub-style activity heatmap, streak tracking and goal management.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,012 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 436 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 298 | 🐛 3 | 🌐 Rust | 📅 2026-09-24 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [rsstig](https://github.com/indium114/rsstig) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - An unconventional terminal RSS/Atom reader.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,239 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,388 | 🐛 34 | 🌐 Rust | 📅 2026-09-25 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 724 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A terminal audio scope with waveform, vector, and frequency views.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 244 | 🐛 12 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [rusty-pipes](https://github.com/dividebysandwich/rusty-pipes) ⭐ 93 | 🐛 7 | 🌐 Rust | 📅 2026-09-15 - Sample-based, MIDI-controlled virtual pipe organ instrument.
...
* [audium](https://github.com/takashialpha/audium) ⭐ 38 | 🐛 1 | 🌐 Rust | 📅 2026-09-25 - A keyboard-driven music app for people who live in the terminal.
* [lrxed](https://github.com/LunaPresent/lrxed) ⭐ 38 | 🐛 0 | 🌐 Rust | 📅 2025-11-02 - A TUI application for synchronizing lyrics.
* [trollstov](https://github.com/hikikones/trollstov) ⭐ 37 | 🐛 0 | 🌐 Rust | 📅 2026-09-26 - A music player for the terminal where your files and their metadata are all you need.
...
* [Youta](https://github.com/vitaly-zdanevich/youta) ⭐ 8 | 🐛 14 | 🌐 Rust | 📅 2026-09-23 - An audio player for YouTube, Yandex Music, podcasts, audiobooks, radio, and local files.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,269 | 🐛 13 | 🌐 Rust | 📅 2026-09-23 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,164 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 936 | 🐛 25 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 775 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
* [mal-cli](https://github.com/L4z3x/mal-cli) ⭐ 162 | 🐛 0 | 🌐 Rust | 📅 2025-07-17 - A terminal client for MyAnimeList.
* [ytsub](https://github.com/sarowish/ytsub) ⭐ 91 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - A subscriptions only TUI YouTube client.
...
* [ratslate](https://github.com/azihsoyn/ratslate) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - An infinite-canvas whiteboard driven by the mouse.

### 🎮 Games and Entertainment

* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 5,000 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 - A TUI screensaver that visualizes Git commit history in your terminal.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,186 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - Terminal-based Chess game.
...
* [pokeductor](https://github.com/Huseynteymurzade28/pokeductor) ⭐ 70 | 🐛 3 | 🌐 Rust | 📅 2026-09-24 - A terminal Pokédex and evolution analyzer with sprite cards.
...
* [sauva](https://github.com/lusingander/sauva) ⭐ 28 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - Terminal Unicode Explorer.
