...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,626 | 🐛 215 | 🌐 Rust | 📅 2026-09-15
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,935 | 🐛 314 | 🌐 Rust | 📅 2026-09-16 - Comprehensive Deep Learning framework in Rust.
* [ratzilla](https://github.com/ratatui/ratzilla) ⭐ 1,452 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/ratatui/mousefood) ⭐ 1,328 | 🐛 22 | 🌐 Rust | 📅 2026-09-15 - An embedded-graphics backend for Ratatui.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 90 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [tachyonfx](https://github.com/ratatui/tachyonfx) ⭐ 1,295 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 - An animation and visual-effects library for Ratatui applications.
* [bevy\_ratatui](https://github.com/ratatui/bevy_ratatui) ⭐ 170 | 🐛 8 | 🌐 Rust | 📅 2026-09-11 - A Rust crate to use Ratatui in a Bevy App.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,499 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,318 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,914 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,102 | 🐛 25 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 533 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
...
* [oha](https://github.com/hatoo/oha) ⭐ 10,549 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - An HTTP load generator with a real-time terminal UI.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,334 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - A database management TUI for Postgres.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,729 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 603 | 🐛 57 | 🌐 Rust | 📅 2026-09-16 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,258 | 🐛 85 | 🌐 Rust | 📅 2026-09-17 - An open-source desktop workspace for general-purpose AI agents.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 939 | 🐛 4 | 🌐 Rust | 📅 2026-09-17 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 846 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - An open-source Rust coding agent for the terminal.
...
* [models](https://github.com/reyamira/models) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 482 | 🐛 8 | 🌐 Rust | 📅 2026-09-17 - Live pixel-art office for AI coding agents.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 232 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A local proxy that compresses large-language-model API requests to reduce token costs, with a dashboard for per-source costs and context usage.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 71 | 🐛 1 | 🌐 Rust | 📅 2026-09-17 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 43 | 🐛 2 | 🌐 Rust | 📅 2026-09-12 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
* [Proqi](https://github.com/oborchers/proqi) ⭐ 29 | 🐛 7 | 🌐 Rust | 📅 2026-09-17 - A terminal-native prompt composer for developers working with coding agents.
...
* [Tree Ring Memory](https://github.com/TerminallyLazy/Tree-Ring-Memory) ⭐ 17 | 🐛 4 | 🌐 Rust | 📅 2026-09-17 - A local-first memory system for AI agents with SQLite full-text search, auditing, forgetting, consolidation, and a Ratatui operator console.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,240 | 🐛 64 | 🌐 Rust | 📅 2026-09-16 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 11 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,513 | 🐛 119 | 🌐 Rust | 📅 2026-09-16 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,432 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,967 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,107 | 🐛 17 | 🌐 Rust | 📅 2026-09-15 - A lightweight TUI app to view and query CSV files.
...
* [sheetsui](https://github.com/zaphar/sheetsui) ⭐ 246 | 🐛 6 | 🌐 Rust | 📅 2026-03-03 - A terminal based spreadsheet application.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 95 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 4 | 🐛 16 | 🌐 Rust | 📅 2026-09-15 - A Terminal Markdown editor that stays rendered while you edit.

### 🧰 Terminal Workflow

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,668 | 🐛 427 | 🌐 Rust | 📅 2026-09-17 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,276 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
* [dekit](https://github.com/pvolok/dekit) ⭐ 2,723 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Run multiple commands in parallel and shows output of each command separately.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,280 | 🐛 35 | 🌐 Rust | 📅 2026-09-14 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 424 | 🐛 10 | 🌐 Rust | 📅 2026-09-17 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 392 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 299 | 🐛 47 | 🌐 Rust | 📅 2026-09-16 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,683 | 🐛 40 | 🌐 Rust | 📅 2026-09-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,972 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,932 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,850 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,161 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 648 | 🐛 26 | 🌐 Rust | 📅 2026-09-17 - Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 106 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - A terminal monitor for live video streams with real-time health checks and metrics.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 91,850 | 🐛 1,125 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,084 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
...
* [purple](https://github.com/erickochen/purple) ⭐ 695 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,510 | 🐛 46 | 🌐 Rust | 📅 2026-09-15 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,284 | 🐛 125 | 🌐 Rust | 📅 2026-09-17 - A matrix chat client with vim keybindings.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,577 | 🐛 2,485 | 🌐 Rust | 📅 2026-09-17 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,026 | 🐛 103 | 🌐 Rust | 📅 2026-09-17 - Cross-platform graphical process/system monitor.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 447 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 117 | 🐛 13 | 🌐 Rust | 📅 2026-09-16 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,536 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - A simple and fast dashboard for Kubernetes.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,840 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,562 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,286 | 🐛 20 | 🌐 Shell | 📅 2026-09-14 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,327 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 839 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,886 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 169 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - A minimal serial monitor with plotter TUI.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,667 | 🐛 73 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven terminal UI for todo.txt.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 140 | 🐛 18 | 🌐 Rust | 📅 2026-09-16 - A terminal task manager that aggregates tasks from multiple providers.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 58 | 🐛 4 | 🌐 Rust | 📅 2026-09-13 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 330 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 43 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [timr-tui](https://github.com/sectore/timr-tui) ⭐ 375 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - TUI to organize your time: Pomodoro, Countdown, Timer, Event.
...
* [hustle-tracker](https://github.com/adolfousier/hustle-tracker) ⭐ 237 | 🐛 0 | 🌐 Rust | 📅 2026-03-16 - A privacy-first TUI to track what apps you use and how long you spend on them.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,007 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,218 | 🐛 155 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,362 | 🐛 35 | 🌐 Rust | 📅 2026-09-16 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,018 | 🐛 16 | 🌐 Rust | 📅 2026-09-16 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,146 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 770 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,981 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A TUI screensaver that visualizes Git commit history in your terminal.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,179 | 🐛 30 | 🌐 Rust | 📅 2026-09-14 - Terminal-based Chess game.
