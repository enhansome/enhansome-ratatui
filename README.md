...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,566 | 🐛 217 | 🌐 Rust | 📅 2026-09-11
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,450 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
...
* [crepuscularity](https://github.com/tschk/crepuscularity) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - One UI codebase for desktop, web, mobile, terminal, browser extensions, and embedded devices. Write React JSX or our lightweight DSL, get GPUI, Ratatui, SwiftUI, LVGL, and more. Batteries included.
...
* [ratatui-splash-screen](https://github.com/orhun/ratatui-splash-screen) ⭐ 154 | 🐛 1 | 🌐 Rust | 📅 2026-09-07 - A widget to turn any image to a splash screen.
* [ratatui-code-editor](https://github.com/vipmax/ratatui-code-editor) ⭐ 115 | 🐛 6 | 🌐 Rust | 📅 2026-07-07 - A code editor widget for ratatui, syntax highlighting powered by tree-sitter.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 116 | 🐛 1 | 🌐 Elixir | 📅 2026-09-12 - Elixir bindings for ratatui.
...
* [burn](https://github.com/burn-rs/burn) ⭐ 15,908 | 🐛 307 | 🌐 Rust | 📅 2026-09-11 - Comprehensive Deep Learning framework in Rust.
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,723 | 🐛 20 | 🌐 Rust | 📅 2026-09-03 - A feature-full TUI API client for your terminal.
...
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,124 | 🐛 80 | 🌐 Rust | 📅 2026-09-13 - An AI coding agent.
* [serie](https://github.com/lusingander/serie) ⭐ 2,094 | 🐛 24 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,781 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,411 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,325 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 933 | 🐛 7 | 🌐 Rust | 📅 2026-09-13 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 842 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A Semantic Coding Agent.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 298 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [giff](https://github.com/bahdotsh/giff) ⭐ 274 | 🐛 8 | 🌐 Rust | 📅 2026-04-23 - A TUI for Git diffs with interactive rebase support.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 229 | 🐛 12 | 🌐 Rust | 📅 2026-09-08 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 24 | 🌐 Rust | 📅 2026-09-12 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 92 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 72 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 67 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 64 | 🐛 5 | 🌐 Rust | 📅 2026-09-13 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [lingora-tui](https://github.com/nigeleke/lingora) ⭐ 35 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - Browse, compare and validate Fluent i18n files.
* [material](https://github.com/azorng/material) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 - A material design color palette for the terminal.
* [Proqi](https://github.com/oborchers/proqi) ⭐ 29 | 🐛 11 | 🌐 Rust | 📅 2026-09-13 - A terminal-native prompt composer for developers working with coding agents.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [Livediff](https://github.com/SoCkEt7/Livediff) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Real-time terminal file diff monitoring TUI.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,174 | 🐛 35 | 🌐 Rust | 📅 2026-09-10 - Terminal-based Chess game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,348 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,205 | 🐛 154 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,908 | 🐛 14 | 🌐 Rust | 📅 2026-09-12 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,339 | 🐛 34 | 🌐 Rust | 📅 2026-09-10 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,140 | 🐛 46 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 716 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A simple oscilloscope/vectorscope/spectroscope for your terminal.
* [twitch-tui](https://github.com/Xithrius/twitch-tui) ⭐ 632 | 🐛 10 | 🌐 Rust | 📅 2026-09-02 - Twitch chat in the terminal.
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 377 | 🐛 3 | 🌐 Rust | 📅 2026-08-22 - A lightweight, customizable TUI music player for local files.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 90,701 | 🐛 1,116 | 🌐 Dart | 📅 2026-09-12
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,547 | 🐛 2,494 | 🌐 Rust | 📅 2026-09-11 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,677 | 🐛 39 | 🌐 Rust | 📅 2026-09-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,964 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,544 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,914 | 🐛 84 | 🌐 Rust | 📅 2026-09-12 - Network diagnostic tool.
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,078 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,848 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,578 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,844 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,656 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,152 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 725 | 🐛 11 | 🌐 Rust | 📅 2026-08-09 - MQTT client for subscribing or publishing to topics.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 72 | 🐛 13 | 🌐 Rust | 📅 2026-09-10 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [jdtui](https://github.com/rylos/jdtui) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A TUI for JDownloader 2 over the My.JDownloader API: downloads, link grabber, accounts and settings, from anywhere.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

### 🚀 Productivity and Utilities

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,605 | 🐛 427 | 🌐 Rust | 📅 2026-09-13 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,262 | 🐛 78 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,262 | 🐛 20 | 🌐 Shell | 📅 2026-09-07 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,505 | 🐛 127 | 🌐 Rust | 📅 2026-09-11 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,428 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,963 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,126 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,101 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - A lightweight TUI app to view and query CSV files.
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,002 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,718 | 🐛 68 | 🌐 Rust | 📅 2026-09-08 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,123 | 🐛 134 | 🌐 Rust | 📅 2026-09-06 - TUI for the Taskwarrior command-line task manager.
...
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,641 | 🐛 63 | 🌐 Rust | 📅 2026-09-13 - A fast, keyboard-driven terminal UI for todo.txt.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,594 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,266 | 🐛 33 | 🌐 Rust | 📅 2026-09-10 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [stu](https://github.com/lusingander/stu) ⭐ 908 | 🐛 15 | 🌐 Rust | 📅 2026-04-30 - A TUI for AWS S3.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 549 | 🐛 21 | 🌐 Rust | 📅 2026-09-12 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 506 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 420 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 324 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 302 | 🐛 2 | 🌐 Rust | 📅 2026-09-12 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 216 | 🐛 14 | 🌐 Rust | 📅 2026-09-13 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 139 | 🐛 18 | 🌐 Rust | 📅 2026-09-11 - Task Aggregator TUI for N providers.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 77 | 🐛 9 | 🌐 Rust | 📅 2026-09-10 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 57 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 35 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [fastcards](https://github.com/indium114/fastcards) ⭐ 10 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - A CLI spaced-repetition flashcard study tool.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 3 | 🐛 15 | 🌐 Rust | 📅 2026-09-11 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,481 | 🐛 45 | 🌐 Rust | 📅 2026-09-12 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,278 | 🐛 127 | 🌐 Rust | 📅 2026-09-12 - A matrix chat client with vim keybindings.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,013 | 🐛 106 | 🌐 Rust | 📅 2026-09-13 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,252 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - Hackable, minimal, and fast TUI file explorer.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,051 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Cross-platform monitoring tool for system stats.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,317 | 🐛 53 | 🌐 Rust | 📅 2026-09-10 - A user-friendly, lightweight TUI for disk imaging.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,837 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,560 | 🐛 4 | 🌐 Rust | 📅 2026-09-13 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 788 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 684 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 117 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [b4n](https://github.com/fioletoven/b4n) ⭐ 105 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A terminal-based tool for browsing Kubernetes resources.
* [quokka](https://github.com/dutradotdev/quokka) ⭐ 101 | 🐛 2 | 🌐 Rust | 📅 2026-07-27 - A TUI to inspect and tidy a USB-connected iPhone from macOS: storage, apps, media, syslog viewer.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-11 - A very feature-rich Modbus Client.
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,751 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
