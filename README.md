...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,484 | 🐛 223 | 🌐 Rust | 📅 2026-09-01
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 44 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 112 | 🐛 1 | 🌐 Elixir | 📅 2026-09-01 - Elixir bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,894 | 🐛 68 | 🌐 Rust | 📅 2026-09-01 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,460 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,858 | 🐛 297 | 🌐 Rust | 📅 2026-09-02 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,318 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management TUI for Postgres.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,724 | 🐛 103 | 🌐 Rust | 📅 2026-08-20 - Ranger-like terminal file manager written in Rust.
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,713 | 🐛 20 | 🌐 Rust | 📅 2026-08-23 - A feature-full TUI API client for your terminal.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,907 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,075 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,897 | 🐛 162 | 🌐 Rust | 📅 2026-09-03 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,766 | 🐛 40 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,376 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
* [openapi-tui](https://github.com/zaghaghi/openapi-tui) ⭐ 1,320 | 🐛 9 | 🌐 Rust | 📅 2026-05-14 - Terminal UI to list, browse and run APIs defined with openapi spec.
...
* [lazyjj](https://github.com/Cretezy/lazyjj) ⭐ 1,203 | 🐛 46 | 🌐 Rust | 📅 2026-03-02 - TUI for the Jujutsu/jj VCS.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 919 | 🐛 8 | 🌐 Rust | 📅 2026-09-03 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 830 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A Semantic Coding Agent.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 528 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
* [patent](https://github.com/r14dd/patent) ⭐ 525 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 466 | 🐛 9 | 🌐 Rust | 📅 2026-09-03 - Live pixel-art office for AI coding agents.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 283 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 276 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
...
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 224 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - Local proxy that compresses LLM API requests to cut token cost, with a tabbed status dashboard for per-source cost and context use.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 133 | 🐛 18 | 🌐 Rust | 📅 2026-09-02 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 69 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 60 | 🐛 4 | 🌐 Rust | 📅 2026-09-03 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [bosun](https://github.com/yetidevworks/bosun) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A tmux-native TUI for orchestrating AI coding agent sessions (Claude Code, Codex) with live previews and per-session state.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 40 | 🐛 6 | 🌐 Rust | 📅 2026-09-02 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
...
* [hedos](https://github.com/theiskaa/hedos) ⭐ 11 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - A terminal shelf for the local AI models already on your machine, with a built-in OpenAI-compatible gateway.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 4 | 🌐 Rust | 📅 2026-09-03 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 12 | 🌐 Rust | 📅 2026-09-03 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [LimitDeck](https://github.com/rockythink/limitdeck) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A compact, privacy-safe terminal dashboard for AI coding subscription limits.
* [VLE](https://github.com/tuffy/vle) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A lightweight text editor.
* [rootle](https://github.com/rootledev/rootle) ⭐ 4 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 - A modal TUI for browsing remote forges (GitHub in-tree, others via stdio providers) with miller columns and syntax-highlighted previews.
...
* [termfarm](https://github.com/indium114/termfarm) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A simple idle farming game.
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,168 | 🐛 174 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,356 | 🐛 5 | 🌐 Rust | 📅 2026-09-02 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,300 | 🐛 30 | 🌐 Rust | 📅 2026-09-02 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,122 | 🐛 45 | 📅 2026-08-30 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [ytui-music](https://github.com/sudipghimire533/ytui-music) ⭐ 775 | 🐛 37 | 🌐 Rust | 📅 2025-03-03 - Listen to music from YouTube in the terminal.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 211 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [deezer-tui](https://github.com/Tatayoyoh/deezer-tui) ⭐ 49 | 🐛 2 | 🌐 Rust | 📅 2026-08-28 - Deezer music TUI with included background player.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,970 | 🐛 1,104 | 🌐 Dart | 📅 2026-08-31
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,509 | 🐛 2,512 | 🌐 Rust | 📅 2026-09-03 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,668 | 🐛 38 | 🌐 Rust | 📅 2026-08-31 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,948 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,523 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,816 | 🐛 79 | 🌐 Rust | 📅 2026-09-03 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,990 | 🐛 16 | 🌐 Rust | 📅 2026-09-03 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,064 | 🐛 4 | 🌐 Rust | 📅 2026-09-03 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,828 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
...
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,648 | 🐛 7 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,135 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 68 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,508 | 🐛 421 | 🌐 Rust | 📅 2026-09-03 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,238 | 🐛 82 | 🌐 Rust | 📅 2026-09-02 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,244 | 🐛 18 | 🌐 Shell | 📅 2026-09-01 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,490 | 🐛 129 | 🌐 Rust | 📅 2026-09-01 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,413 | 🐛 39 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,952 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,119 | 🐛 132 | 🌐 Rust | 📅 2026-08-30 - TUI for the Taskwarrior command-line task manager.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,095 | 🐛 31 | 🌐 Rust | 📅 2026-09-01 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 981 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [tui-journal](https://github.com/AmmarAbouZor/tui-journal) ⭐ 777 | 🐛 23 | 🌐 Rust | 📅 2026-09-02 - Journaling/Notes-taking terminal-based app.
* [flawz](https://github.com/orhun/flawz) ⭐ 603 | 🐛 15 | 🌐 Rust | 📅 2026-06-13 - A TUI for browsing security vulnerabilities (CVEs).
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 543 | 🐛 21 | 🌐 Rust | 📅 2026-09-02 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 298 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 214 | 🐛 13 | 🌐 Rust | 📅 2026-09-02 - A customizable terminal splash rendered on shell startup or directory updates.
...
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 10 | 🌐 Rust | 📅 2026-08-29 - A TUI feed viewer.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 29 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - A TUI calendar with Google Calendar sync and DAG-linked events.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 1 | 🐛 11 | 🌐 Rust | 📅 2026-09-02 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,301 | 🐛 42 | 🌐 Rust | 📅 2026-09-01 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,274 | 🐛 167 | 🌐 Rust | 📅 2026-09-02 - A matrix chat client with vim keybindings.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 4 | 🌐 Rust | 📅 2026-08-31 - A TUI client for Nostr.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,970 | 🐛 106 | 🌐 Rust | 📅 2026-09-03 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,215 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,815 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - Hackable, minimal, and fast TUI file explorer.
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,046 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - Cross-platform monitoring tool for system stats.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,288 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,861 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,825 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) ⭐ 1,576 | 🐛 5 | 🌐 Rust | 📅 2026-08-03 - A program for managing systemd services through a TUI.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,557 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 743 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 670 | 🐛 6 | 🌐 Rust | 📅 2026-09-02 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 352 | 🐛 11 | 🌐 Rust | 📅 2026-08-29 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [mirro-rs](https://github.com/rtkay123/mirro-rs) ⭐ 117 | 🐛 23 | 🌐 Rust | 📅 2026-09-02 - An Arch Linux mirrorlist manager with a TUI.
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 115 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 77 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [Tuitar](https://github.com/orhun/tuitar) ⭐ 527 | 🐛 6 | 🌐 Rust | 📅 2025-12-23 - A portable guitar training tool.
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-03 - A minimal serial monitor with plotter TUI.
* [Phone-OS](https://github.com/Julien-cpsn/Phone-OS) ⭐ 45 | 🐛 1 | 🌐 Rust | 📅 2025-09-06 - A modern Phone OS for ESP32 CYD (Cheap Yellow Display).
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - A very feature-rich Modbus Client.
...
* [cotp](https://github.com/replydev/cotp) ⭐ 384 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - Command-line TOTP/HOTP authenticator app.
