...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,457 | 🐛 222 | 🌐 Rust | 📅 2026-08-29
...
* [ratzilla](https://github.com/orhun/ratzilla) ⭐ 1,435 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
* [mousefood](https://github.com/j-g00da/mousefood) ⭐ 1,320 | 🐛 22 | 🌐 Rust | 📅 2026-08-24 - An embedded-graphics backend for Ratatui.
...
* [egui-ratatui](https://github.com/gold-silver-copper/egui_ratatui) ⭐ 207 | 🐛 4 | 🌐 Rust | 📅 2026-04-16 - A ratatui backend that is also an egui widget. Deploy on web with WebAssembly or ship natively with bevy, macroquad, or eframe.
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 16 | 🐛 6 | 🌐 Python | 📅 2026-08-26 - A declarative terminal framework for Python built on ratatui & ratzilla.
...
* [ratatui-markdown](https://github.com/celestia-island/ratatui-markdown) ⭐ 42 | 🐛 2 | 🌐 Rust | 📅 2026-08-28 - A Rust library providing markdown rendering, Mermaid diagrams, syntax highlighting, collapsible JSON/TOML tree views, and a rich hybrid scroll system.
...
* [bevy\_ratatui](https://github.com/joshka/bevy_ratatui) ⭐ 166 | 🐛 9 | 🌐 Rust | 📅 2026-08-18 - A Rust crate to use Ratatui in a Bevy App.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 112 | 🐛 0 | 🌐 Elixir | 📅 2026-08-26 - Elixir bindings for ratatui.
...
* [Ratatui.cs](https://github.com/holo-q/Ratatui.cs) ⭐ 14 | 🐛 0 | 🌐 C# | 📅 2026-06-04 - C# bindings for ratatui.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 41,823 | 🐛 69 | 🌐 Rust | 📅 2026-08-31 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,450 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [burn](https://github.com/burn-rs/burn) ⭐ 15,842 | 🐛 310 | 🌐 Rust | 📅 2026-08-30 - Comprehensive Deep Learning framework in Rust.
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,305 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database management TUI for Postgres.
...
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,308 | 🐛 13 | 🌐 Rust | 📅 2026-07-03 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,905 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,068 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 - A rich Git commit graph in your terminal.
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 1,878 | 🐛 190 | 🌐 Rust | 📅 2026-08-31 - An AI coding agent.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,761 | 🐛 39 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 916 | 🐛 20 | 🌐 Rust | 📅 2026-08-31 - Open-claw inspired orchestration layer for software development.
* [Serpl](https://github.com/yassinebridi/serpl) ⭐ 856 | 🐛 22 | 🌐 Rust | 📅 2026-05-31 - A simple terminal UI for search and replace, ala VS Code.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 825 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A Semantic Coding Agent.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 527 | 🐛 2 | 🌐 Rust | 📅 2026-08-30 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
* [patent](https://github.com/r14dd/patent) ⭐ 524 | 🐛 12 | 🌐 Rust | 📅 2026-08-31 - A prior-art search for devtool ideas.
  LLM verdict.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 462 | 🐛 12 | 🌐 Rust | 📅 2026-08-31 - Live pixel-art office for AI coding agents.
...
* [drydock](https://github.com/yetidevworks/drydock) ⭐ 267 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A live dashboard for a fleet of Git repos, showing what's uncommitted, unpushed, and unreleased across all of them.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 259 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 - A fast, driver-less TUI for browsing, querying, and editing PostgreSQL databases with vim-like keybindings.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 66 | 🐛 1 | 🌐 Rust | 📅 2026-08-31 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
...
* [ygrep](https://github.com/yetidevworks/ygrep) ⭐ 58 | 🐛 1 | 🌐 Rust | 📅 2026-08-27 - A fast, local, indexed code search tool with a TUI, optimized for AI coding assistants and powered by Tantivy full-text indexing.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 57 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A local dashboard for Codex and Claude Code.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 12 | 🐛 4 | 🌐 Rust | 📅 2026-08-26 - A peer-to-peer terminal multiplexer where every pane is a PTY on its owner's own machine, with an inbox of the coding agents running across all of them.
...
* [Reeve](https://github.com/Dancode-188/reeve) ⭐ 7 | 🐛 13 | 🌐 Rust | 📅 2026-08-31 - A terminal cockpit for AI agents: watch a run live, score it, and step in when it goes sideways.
...
* [VLE](https://github.com/tuffy/vle) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - A lightweight text editor.
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 5 | 🐛 6 | 🌐 Rust | 📅 2026-08-31 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,582 | 🐛 17 | 🌐 Rust | 📅 2026-08-27 - A CLI code-typing game that turns your source code into typing challenges.
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,164 | 🐛 31 | 🌐 Rust | 📅 2026-08-27 - Terminal-based Chess game.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,336 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,157 | 🐛 173 | 🌐 Rust | 📅 2026-07-20 - An independently developed Spotify player with full feature parity.
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 1,329 | 🐛 10 | 🌐 Rust | 📅 2026-08-31 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,286 | 🐛 36 | 🌐 Rust | 📅 2026-08-29 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 927 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 - Terminal-based manga reader and downloader with image support.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 209 | 🐛 10 | 🌐 Rust | 📅 2026-08-13 - Modern Spotify player for the terminal. With reactive themes.
...
* [rs-pug](https://github.com/JustRoccat/rs-pug) ⭐ 68 | 🐛 0 | 🌐 Rust | 📅 2026-08-20 - A Neovim-inspired asynchronous music player with a reactive audio visualizer.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 89,776 | 🐛 1,094 | 🌐 Dart | 📅 2026-08-30
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,492 | 🐛 2,515 | 🌐 Rust | 📅 2026-08-29 - A high-performance observability data pipeline.
* [gping](https://github.com/orf/gping/) ⭐ 12,662 | 🐛 51 | 🌐 Rust | 📅 2026-08-30 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,939 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [oha](https://github.com/hatoo/oha) ⭐ 10,520 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 - Top-like monitoring tool for HTTP(S) traffic.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,600 | 🐛 79 | 🌐 Rust | 📅 2026-08-31 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,975 | 🐛 15 | 🌐 Rust | 📅 2026-08-30 - A cross-platform network monitoring tool with deep packet inspection.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,060 | 🐛 5 | 🌐 Rust | 📅 2026-08-30 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [impala](https://github.com/pythops/impala) ⭐ 2,816 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-08-28 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,828 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
* [AdGuardian-Term](https://github.com/Lissy93/AdGuardian-Term) ⭐ 1,645 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - Real-time traffic monitoring and statistics for AdGuard Home.
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,120 | 🐛 0 | 🌐 Rust | 📅 2026-08-07 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 643 | 🐛 31 | 🌐 Rust | 📅 2026-08-31 - Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
* [unifly](https://github.com/hyperb1iss/unifly) ⭐ 249 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - CLI and TUI for managing Ubiquiti UniFi network controllers with an 8-screen dashboard, live traffic charts, and dual-API coverage.
...
* [mxr](https://github.com/planetaryescape/mxr) ⭐ 70 | 🐛 11 | 🌐 Rust | 📅 2026-08-26 - Local-first email client with Vim-style navigation, multi-account sync, and full-text search.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 36 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Terminal-based diagnostic and validation tool for live HLS, DASH, and IPTV streams.
...
* [LazyMQTT](https://github.com/ScottFelder/lazymqtt) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - Terminal UI MQTT client with features like saved connections, live topic tree, and message inspector.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

### 🚀 Productivity and Utilities

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,473 | 🐛 420 | 🌐 Rust | 📅 2026-08-31 - Magical shell history.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,227 | 🐛 83 | 🌐 Rust | 📅 2026-08-16 - A blazingly fast general purpose fuzzy finder for your terminal.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,236 | 🐛 15 | 🌐 Shell | 📅 2026-08-17 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [xan](https://github.com/medialab/xan) ⭐ 4,486 | 🐛 125 | 🌐 Rust | 📅 2026-07-31 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,411 | 🐛 38 | 🌐 Rust | 📅 2026-08-30 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,947 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,121 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 - Terminal-based disk space navigator.
* [tabiew](https://github.com/shshemi/tabiew) ⭐ 3,091 | 🐛 15 | 🌐 Rust | 📅 2026-08-31 - A lightweight TUI app to view and query CSV files.
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,983 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 - A TUI for managing Bluetooth devices.
* [mprocs](https://github.com/pvolok/mprocs) ⭐ 2,707 | 🐛 67 | 🌐 Rust | 📅 2026-08-29 - Run multiple commands in parallel and shows output of each command separately.
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,115 | 🐛 132 | 🌐 Rust | 📅 2026-08-30 - TUI for the Taskwarrior command-line task manager.
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,755 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 - Manage your GnuPG keys with ease!.
* [tickrs](https://github.com/tarkah/tickrs) ⭐ 1,685 | 🐛 33 | 🌐 Rust | 📅 2026-05-19 - Stock market ticker in the terminal.
* [ttyper](https://github.com/max-niederman/ttyper) ⭐ 1,592 | 🐛 36 | 🌐 Rust | 📅 2026-04-07 - Terminal-based typing test.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,591 | 🐛 59 | 🌐 Rust | 📅 2026-08-19 - A fast, keyboard-driven terminal UI for todo.txt.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,089 | 🐛 25 | 🌐 Rust | 📅 2026-08-30 - A Bash plugin TUI for an enhanced command line writing experience.
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 954 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 540 | 🐛 20 | 🌐 Rust | 📅 2026-08-30 - Markdown renderer in the terminal.
...
* [models](https://github.com/arimxyer/models) ⭐ 503 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A TUI for browsing AI models, benchmarks, and coding agents.
...
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 293 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 292 | 🐛 44 | 🌐 Rust | 📅 2026-08-26 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [work-tuimer](https://github.com/Kamyil/work-tuimer) ⭐ 262 | 🐛 9 | 🌐 Rust | 📅 2026-05-18 - A TUI for easier time tracking each day, task-per-task with summaries.
* [budget\_tracker\_tui](https://github.com/Feromond/budget_tracker_tui) ⭐ 260 | 🐛 13 | 🌐 Rust | 📅 2026-08-30 - A fast, keyboard-driven TUI for tracking expenses, managing categories, and analyzing your budget with ease.
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 165 | 🐛 7 | 🌐 Rust | 📅 2026-08-31 - TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [codemark](https://github.com/DanielCardonaRojas/codemark) ⭐ 123 | 🐛 7 | 🌐 Rust | 📅 2026-08-19 - A semantic code bookmarking system for humans and agents.
...
* [focusd](https://github.com/bibekbhusal0/focusd) ⭐ 45 | 🐛 2 | 🌐 Rust | 📅 2026-08-26 - A terminal pomodoro timer with daemon, stats, history, streak, and nice interface.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 0 | 🐛 12 | 🌐 Rust | 📅 2026-08-26 - A Terminal Markdown editor that stays rendered while you edit.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,289 | 🐛 41 | 🌐 Rust | 📅 2026-08-31 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,272 | 🐛 163 | 🌐 Rust | 📅 2026-08-31 - A matrix chat client with vim keybindings.
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 4 | 🌐 Rust | 📅 2026-08-26 - A TUI client for Nostr.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,954 | 🐛 106 | 🌐 Rust | 📅 2026-08-31 - Cross-platform graphical process/system monitor.
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,199 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - View disk space usage and delete unwanted data, fast.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,814 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - Hackable, minimal, and fast TUI file explorer.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,277 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 - A user-friendly, lightweight TUI for disk imaging.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,856 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,555 | 🐛 19 | 🌐 Rust | 📅 2026-08-30 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 920 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 - A terminal app for managing Docker containers, inspired by K9s.
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 737 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
* [purple](https://github.com/erickochen/purple) ⭐ 664 | 🐛 7 | 🌐 Rust | 📅 2026-08-31 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 393 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 - TUI for real-time monitoring of Kubernetes resources.
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 352 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 - A TUI for controlling and monitoring Framework Computers hardware.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 69 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - A minimal serial monitor with plotter TUI.
...
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,353 | 🐛 80 | 🌐 Rust | 📅 2026-06-28 - A customizable TUI login manager for Linux and BSD.
