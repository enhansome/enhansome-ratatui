...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,637 | 🐛 216 | 🌐 Rust | 📅 2026-09-15
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,942 | 🐛 311 | 🌐 Rust | 📅 2026-09-17 - Comprehensive Deep Learning framework in Rust.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 90 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [ex\_ratatui](https://github.com/mcass19/ex_ratatui) ⭐ 116 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - Elixir bindings for ratatui.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,502 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
...
* [gitu](https://github.com/altsem/gitu) ⭐ 2,914 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,105 | 🐛 25 | 🌐 Rust | 📅 2026-09-08 - A rich Git commit graph in your terminal.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 135 | 🐛 26 | 🌐 Rust | 📅 2026-09-14 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [repgrep](https://github.com/acheronfail/repgrep) ⭐ 534 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line.
...
* [BugStalker](https://github.com/godzie44/BugStalker) ⭐ 1,414 | 🐛 15 | 🌐 Rust | 📅 2026-08-22 - Modern rust debugger for Linux x86-64.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 603 | 🐛 57 | 🌐 Rust | 📅 2026-09-17 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [wireman](https://github.com/preiter93/wireman) ⭐ 179 | 🐛 7 | 🌐 Rust | 📅 2026-09-18 - A terminal client for calling gRPC services.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,276 | 🐛 55 | 🌐 Rust | 📅 2026-09-18 - An open-source desktop workspace for general-purpose AI agents.
* [Stakpak](https://github.com/stakpak/agent) ⭐ 1,789 | 🐛 41 | 🌐 Rust | 📅 2026-07-06 - AI DevOps agent to help you secure, deploy, and maintain production-ready infrastructure.
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 939 | 🐛 12 | 🌐 Rust | 📅 2026-09-17 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 847 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - An open-source Rust coding agent for the terminal.
...
* [models](https://github.com/reyamira/models) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 482 | 🐛 8 | 🌐 Rust | 📅 2026-09-17 - Live pixel-art office for AI coding agents.
...
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 72 | 🐛 9 | 🌐 Rust | 📅 2026-09-18 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [Proqi](https://github.com/oborchers/proqi) ⭐ 29 | 🐛 8 | 🌐 Rust | 📅 2026-09-18 - A terminal-native prompt composer for developers working with coding agents.
...
* [Tree Ring Memory](https://github.com/TerminallyLazy/Tree-Ring-Memory) ⭐ 17 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - A local-first memory system for AI agents with SQLite full-text search, auditing, forgetting, consolidation, and a Ratatui operator console.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,268 | 🐛 64 | 🌐 Rust | 📅 2026-09-17 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,825 | 🐛 11 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,512 | 🐛 120 | 🌐 Rust | 📅 2026-09-17 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,433 | 🐛 38 | 🌐 Rust | 📅 2026-09-13 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,970 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,755 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
* [joshuto](https://github.com/kamiyaa/joshuto) ⭐ 3,728 | 🐛 102 | 🌐 Rust | 📅 2026-09-17 - Ranger-like terminal file manager written in Rust.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 550 | 🐛 24 | 🌐 Rust | 📅 2026-09-16 - Markdown renderer in the terminal.
...
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,684 | 🐛 409 | 🌐 Rust | 📅 2026-09-17 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,278 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
* [dekit](https://github.com/pvolok/dekit) ⭐ 2,724 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Run multiple commands in parallel and shows output of each command separately.
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,281 | 🐛 35 | 🌐 Rust | 📅 2026-09-17 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [fsel](https://github.com/Mjoyufull/fsel) ⭐ 426 | 🐛 10 | 🌐 Rust | 📅 2026-09-17 - A TUI app launcher and fuzzy finder for GNU/Linux and BSD.
* [kbt](https://github.com/bloznelis/kbt) ⭐ 392 | 🐛 5 | 🌐 Rust | 📅 2025-11-26 - Keyboard tester in terminal.
* [fzf-make](https://github.com/kyu08/fzf-make) ⭐ 300 | 🐛 47 | 🌐 Rust | 📅 2026-09-16 - A command line tool that executes make target using fuzzy finder with preview window.
...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 72 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - A peer-to-peer terminal multiplexer for sharing sessions across machines.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,684 | 🐛 40 | 🌐 Rust | 📅 2026-09-10 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,977 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,935 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,030 | 🐛 32 | 🌐 Rust | 📅 2026-09-17 - A cross-platform network monitoring tool with deep packet inspection.
* [impala](https://github.com/pythops/impala) ⭐ 2,853 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,580 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,852 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,165 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 730 | 🐛 12 | 🌐 Rust | 📅 2026-08-09 - A terminal client for subscribing to and publishing messages over MQTT.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 91,962 | 🐛 1,126 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,085 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [slumber](https://github.com/LucasPickering/slumber) ⭐ 1,228 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - Terminal-based HTTP/REST client.
* [purple](https://github.com/erickochen/purple) ⭐ 697 | 🐛 4 | 🌐 Rust | 📅 2026-09-17 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,523 | 🐛 46 | 🌐 Rust | 📅 2026-09-15 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,284 | 🐛 119 | 🌐 Rust | 📅 2026-09-18 - A matrix chat client with vim keybindings.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,582 | 🐛 2,482 | 🌐 Rust | 📅 2026-09-18 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,031 | 🐛 103 | 🌐 Rust | 📅 2026-09-18 - Cross-platform graphical process/system monitor.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 450 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [winproc-tui](https://github.com/TX230/winproc-tui) ⭐ 117 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Process monitoring tool with live metrics, time-series graphs, A/B comparison.
...
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,562 | 🐛 2 | 🌐 Rust | 📅 2026-09-18 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [reeve](https://github.com/yetidevworks/reeve) ⭐ 89 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - Manages a local web stack as per-user services: Caddy, Apache or nginx, per-vhost PHP-FPM versions, databases, local SSL, and wildcard DNS.
...
* [dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,270 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - View disk space usage and delete unwanted data, fast.
* [linutil](https://github.com/ChrisTitusTech/linutil) ⭐ 5,287 | 🐛 20 | 🌐 Shell | 📅 2026-09-14 - A distro-agnostic toolbox designed to simplify everyday Linux tasks.
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,328 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 848 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,887 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 - Sudoless performance monitoring for Apple Silicon processors.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - A minimal serial monitor with plotter TUI.
...
* [MTUI](https://github.com/inowattio/mtui) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-09-17 - A terminal client for Modbus industrial devices.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,128 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - TUI for the Taskwarrior command-line task manager.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,674 | 🐛 73 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven terminal UI for todo.txt.
* [mirador](https://github.com/jchultarsky/mirador) ⭐ 312 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A personal dashboard with world clocks, calendar, weather, tasks, notes, a market watchlist and live CPU and network graphs.
...
* [kanban](https://github.com/kanban-rs/kanban) ⭐ 169 | 🐛 10 | 🌐 Rust | 📅 2026-09-15 - TUI kanban board for projects management with sprint tracking and task prioritization.
* [Jirust](https://github.com/Code-Militia/jirust) ⭐ 160 | 🐛 6 | 🌐 Rust | 📅 2024-05-29 - A Jira TUI.
* [tatuin](https://github.com/panter-dsd/tatuin) ⭐ 141 | 🐛 18 | 🌐 Rust | 📅 2026-09-18 - A terminal task manager that aggregates tasks from multiple providers.
...
* [solverforge-calendar](https://github.com/blackopsrepl/solverforge-calendar) ⭐ 19 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - A local-first TUI calendar with an AI planning inbox that schedules your to-dos into reviewable proposals, plus Google Calendar sync and .ics import.
...
* [kimün](https://github.com/nico2sh/kimun) ⭐ 58 | 🐛 5 | 🌐 Rust | 📅 2026-09-18 - A terminal-based Markdown note taking app that combines an interactive TUI with a scriptable CLI for automation.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 332 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
...
* [alphai-tui](https://github.com/makeev/alphai-tui) ⭐ 45 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - A stock dashboard with quotes, candlestick charts, AI-scored news and SEC Form 4 insider activity.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,009 | 🐛 4 | 🌐 Rust | 📅 2026-09-18 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
...
* [synd](https://github.com/ymgyt/syndicationd) ⭐ 154 | 🐛 10 | 🌐 Rust | 📅 2026-09-17 - A TUI feed viewer.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,349 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,221 | 🐛 155 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,363 | 🐛 35 | 🌐 Rust | 📅 2026-09-17 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [NoctaVox](https://github.com/Jaxx497/noctavox) ⭐ 378 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - A lightweight, customizable TUI music player for local files.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 228 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,038 | 🐛 17 | 🌐 Rust | 📅 2026-09-16 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,150 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 770 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
