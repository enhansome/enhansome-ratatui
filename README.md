...
* <https://github.com/ratatui/ratatui/network/dependents> ⭐ 22,651 | 🐛 215 | 🌐 Rust | 📅 2026-09-18
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 15,948 | 🐛 309 | 🌐 Rust | 📅 2026-09-18 - Comprehensive Deep Learning framework in Rust.
* [ratzilla](https://github.com/ratatui/ratzilla) ⭐ 1,453 | 🐛 49 | 🌐 Rust | 📅 2026-07-04 - Build terminal-themed web applications with Ratatui and WebAssembly.
...
* [schemaui](https://github.com/YuniqueUnic/schemaui) ⭐ 91 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - Turn JSON Schemas into TUIs and web UIs with real-time validation.
...
* [jatatui](https://github.com/oyvindberg/jatatui) ⭐ 287 | 🐛 1 | 🌐 Java | 📅 2026-08-22 - A Java port of ratatui.
* [pyratatui](https://github.com/programmersd21/pyratatui) ⭐ 154 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - Python bindings for Ratatui powered by PyO3, featuring async support, many widgets, and advanced terminal animations via TachyonFX.
...
* [gitui](https://github.com/gitui-org/gitui) ⭐ 22,505 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - Terminal UI for Git.
* [wrkflw](https://github.com/bahdotsh/wrkflw) ⭐ 3,320 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - A TUI for validating and executing GitHub Actions workflows locally.
* [gitu](https://github.com/altsem/gitu) ⭐ 2,916 | 🐛 60 | 🌐 Rust | 📅 2026-08-22 - A TUI Git client inspired by Magit.
* [serie](https://github.com/lusingander/serie) ⭐ 2,106 | 🐛 26 | 🌐 Rust | 📅 2026-09-19 - A rich Git commit graph in your terminal.
...
* [gwm](https://github.com/kbrdn1/gwm-cli) ⭐ 136 | 🐛 19 | 🌐 Rust | 📅 2026-09-19 - A Git worktree manager: CLI and TUI in one binary, native libgit2, per-repo declarative bootstrap, and AI agent session tracking.
...
* [Surfpool](https://github.com/solana-foundation/surfpool) ⭐ 602 | 🐛 53 | 🌐 Rust | 📅 2026-09-18 - A local-first Solana development environment with mainnet state, infrastructure as code and transaction debugging.
...
* [OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐ 2,290 | 🐛 57 | 🌐 Rust | 📅 2026-09-19 - An open-source desktop workspace for general-purpose AI agents.
...
* [opencrabs](https://github.com/adolfousier/opencrabs) ⭐ 939 | 🐛 15 | 🌐 Rust | 📅 2026-09-19 - An all-in-one AI agent for the terminal with TUI, CLI, and daemon modes.
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 848 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - An open-source Rust coding agent for the terminal.
...
* [models](https://github.com/reyamira/models) ⭐ 508 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - A TUI for browsing AI models, benchmarks, and coding agents.
* [pixtuoid](https://github.com/IvanWng97/pixtuoid) ⭐ 480 | 🐛 8 | 🌐 Rust | 📅 2026-09-18 - Live pixel-art office for AI coding agents.
* [llmtrim](https://github.com/fkiene/llmtrim) ⭐ 235 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A local proxy that compresses large-language-model API requests to reduce token costs, with a dashboard for per-source costs and context usage.
* [claudectl](https://github.com/mercurialsolo/claudectl) ⭐ 200 | 🐛 63 | 🌐 Rust | 📅 2026-07-10 - Mission control for multiple Claude Code sessions with live dashboard, cost tracking, and budget enforcement.
...
* [Martty](https://github.com/openma-ai/Martty) ⭐ 76 | 🐛 4 | 🌐 Rust | 📅 2026-09-18 - An extensible Rust/ratatui terminal client for DeepSeek Harness and ACP-compatible coding agents, with plugins, tools, subagents, and durable sessions.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 72 | 🐛 9 | 🌐 Rust | 📅 2026-09-19 - A TUI orchestrator for running multiple AI coding agents (Claude Code, Codex, and others) in persistent tmux sessions.
...
* [SynapsCLI](https://github.com/HaseebKhalid1507/SynapsCLI) ⭐ 44 | 🐛 2 | 🌐 Rust | 📅 2026-09-12 - Lightning fast terminal native agent harness with tools, extensions and subagents. 15MB, 2ms boot.
* [Proqi](https://github.com/oborchers/proqi) ⭐ 33 | 🐛 11 | 🌐 Rust | 📅 2026-09-18 - A terminal-native prompt composer for developers working with coding agents.
...
* [agent-console](https://github.com/buhuipao/agent-console) ⭐ 22 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A local dashboard for Codex and Claude Code.
...
* [Forge](https://github.com/NorviaLabs/forge) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - An AI coding agent that unifies an agent, code editor, and shell in a single keyboard-driven terminal workspace.
...
* [Yazi](https://github.com/sxyazi/yazi) ⭐ 42,285 | 🐛 65 | 🌐 Rust | 📅 2026-09-18 - Blazing fast terminal file manager written in Rust, based on async I/O.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,825 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - Hackable, minimal, and fast TUI file explorer.
* [xan](https://github.com/medialab/xan) ⭐ 4,515 | 🐛 122 | 🌐 Rust | 📅 2026-09-18 - A terminal tool for processing CSV files.
* [binsider](https://github.com/orhun/binsider) ⭐ 4,432 | 🐛 37 | 🌐 Rust | 📅 2026-09-18 - A TUI for analyzing binary files.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,971 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 - Command line csv viewer.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,755 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - Document viewer for Microsoft Word files.
...
* [md-tui](https://github.com/henriklovhaug/md-tui) ⭐ 551 | 🐛 24 | 🌐 Rust | 📅 2026-09-18 - Markdown renderer in the terminal.
...
* [wiper](https://github.com/ikebastuz/wiper) ⭐ 250 | 🐛 11 | 🌐 Rust | 📅 2025-11-14 - Disk space analyzer and cleanup tool.
...
* [rat-commander](https://github.com/dividebysandwich/rat-commander) ⭐ 95 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - A fully-featured modern spiritual successor to Midnight-Commander with truecolor support and built-in process- and disk-explorer.
...
* [edamame](https://github.com/mijowi/edamame) ⭐ 4 | 🐛 20 | 🌐 Rust | 📅 2026-09-15 - A Terminal Markdown editor that stays rendered while you edit.

### 🧰 Terminal Workflow

* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,702 | 🐛 413 | 🌐 Rust | 📅 2026-09-19 - A shell history manager with fast search and optional sync.
* [television](https://github.com/alexpasmantier/television) ⭐ 6,282 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 - A blazingly fast general purpose fuzzy finder for your terminal.
...
* [flyline](https://github.com/HalFrgrd/flyline) ⭐ 1,284 | 🐛 35 | 🌐 Rust | 📅 2026-09-17 - A Bash plugin TUI for an enhanced command line writing experience.
...
* [splashboard](https://github.com/unhappychoice/splashboard) ⭐ 215 | 🐛 16 | 🌐 Rust | 📅 2026-09-15 - A customizable terminal splash rendered on shell startup or directory updates.
* [snipt](https://github.com/snipt/snipt) ⭐ 149 | 🐛 5 | 🌐 Rust | 📅 2026-04-02 - A text snippet expansion tool with a TUI for managing snippets.
* [sigye](https://github.com/am2rican5/sigye) ⭐ 129 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - A terminal clock with FIGlet fonts, customizable themes, and animated backgrounds.
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 72 | 🐛 2 | 🌐 Rust | 📅 2026-09-18 - A peer-to-peer terminal multiplexer for sharing sessions across machines.
...
* [gping](https://github.com/orf/gping/) ⭐ 12,684 | 🐛 41 | 🌐 Rust | 📅 2026-09-18 - Ping tool with a graph.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,978 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 - Displays network utilization by process.
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,941 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 - Network diagnostic tool.
...
* [impala](https://github.com/pythops/impala) ⭐ 2,855 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - TUI for managing wifi on Linux.
* [oryx](https://github.com/pythops/oryx) ⭐ 2,579 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF.
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,854 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 - Network scanning tool.
...
* [dnsglobe](https://github.com/514-labs/dnsglobe) ⭐ 1,174 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Global DNS propagation checker querying 34 resolvers worldwide, with a world map.
...
* [streamtop](https://github.com/Jorji49/streamtop) ⭐ 108 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - A terminal monitor for live video streams with real-time health checks and metrics.
...
* [FlowLens](https://github.com/power4j/flowlens) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A cross-platform network traffic analyzer with process, IP, and outbound-domain attribution.
...
* [JocalSend](https://git.kittencollective.com/nebkor/joecalsend) - Peer to peer local file and data transfer, compatible with [LocalSend](https://github.com/localsend/localsend) ⭐ 92,060 | 🐛 1,128 | 🌐 Dart | 📅 2026-09-14
* [termscp](https://github.com/veeso/termscp) ⭐ 3,089 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - A feature rich terminal UI file transfer and explorer with support for SCP/SFTP/FTP/S3/SMB.
* [slumber](https://github.com/LucasPickering/slumber) ⭐ 1,228 | 🐛 9 | 🌐 Rust | 📅 2026-09-02 - Terminal-based HTTP/REST client.
* [purple](https://github.com/erickochen/purple) ⭐ 698 | 🐛 4 | 🌐 Rust | 📅 2026-09-17 - TUI SSH config manager & launcher with fuzzy search, tags, cloud provider sync, tunnels and command snippets for server management.
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 696 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 - A nyaa.si tui tool for browsing and downloading torrents.
...
* [jdtui](https://github.com/rylos/jdtui) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A TUI for JDownloader 2 over the My.JDownloader API: downloads, link grabber, accounts and settings, from anywhere.
* [traxor](https://github.com/kristoferssolo/traxor) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A TUI for managing Transmission torrents.

#### Communications and Social

* [concord](https://github.com/chojs23/concord) ⭐ 1,530 | 🐛 44 | 🌐 Rust | 📅 2026-09-19 - A TUI client for Discord.
* [iamb](https://github.com/ulyssa/iamb) ⭐ 1,287 | 🐛 115 | 🌐 Rust | 📅 2026-09-19 - A matrix chat client with vim keybindings.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - TUI for the lobste.rs website.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,583 | 🐛 2,486 | 🌐 Rust | 📅 2026-09-18 - A high-performance observability data pipeline.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,032 | 🐛 104 | 🌐 Rust | 📅 2026-09-18 - Cross-platform graphical process/system monitor.
...
* [diskwatch](https://github.com/matthart1983/diskwatch) ⭐ 455 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Single-host, read-only disk diagnostics TUI.
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,842 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - Simple TUI to view & control Docker containers.
* [kftui](https://github.com/hcavarsan/kftray/blob/main/README.md#kftui) ⭐ 1,564 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI to manage multiple kubectl port-forward commands, with support for UDP and Kubernetes proxy.
...
* [caligula](https://github.com/ifd3f/caligula) ⭐ 2,330 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 - A user-friendly, lightweight TUI for disk imaging.
...
* [lemurs](https://github.com/coastalwhite/lemurs) ⭐ 1,355 | 🐛 78 | 🌐 Rust | 📅 2026-09-16 - A customizable TUI login manager for Linux and BSD.
* [lazyrsync](https://github.com/westpoint-io/lazyrsync) ⭐ 851 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - A TUI for rsync: reusable profiles, a dry-run diff preview, and live run progress.
...
* [ComChan](https://github.com/Vaishnav-Sabari-Girish/ComChan) ⭐ 170 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 - A minimal serial monitor with plotter TUI.
...
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,130 | 🐛 132 | 🌐 Rust | 📅 2026-09-13 - TUI for the Taskwarrior command-line task manager.
* [tuxedo](https://github.com/webstonehq/tuxedo) ⭐ 1,677 | 🐛 73 | 🌐 Rust | 📅 2026-09-14 - A fast, keyboard-driven terminal UI for todo.txt.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 333 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 - A fast, keyboard-driven TUI for tracking expenses, tracking investments, and analyzing your budget with ease.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,009 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - A TUI RSS reader based on the news\_flash library inspired by Neovim and co.
* [feedr](https://github.com/bahdotsh/feedr) ⭐ 432 | 🐛 8 | 🌐 Rust | 📅 2026-06-11 - A terminal-based RSS/Atom feed reader with a TUI.
* [ostt](https://github.com/kristoferlund/ostt) ⭐ 295 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - Open Speech-to-Text recording tool with real-time volume metering and transcription.
...
* [leetrs](https://github.com/shadowmkj/leetrs) ⭐ 91 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - A TUI for browsing, testing, and submitting LeetCode problems directly from your terminal.
...
* [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,351 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - (Unmaintained) The original Spotify TUI; see spotatui (direct fork) or spotify-player (independent alternative).
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,224 | 🐛 156 | 🌐 Rust | 📅 2026-09-12 - An independently developed Spotify player with full feature parity.
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,366 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 - Spotify client with native streaming, synced lyrics, and audio visualization. A direct fork of spotify-tui with continued development and new features.
...
* [scope-tui](https://github.com/alemidev/scope-tui) ⭐ 717 | 🐛 12 | 🌐 Rust | 📅 2026-03-01 - A terminal audio scope with waveform, vector, and frequency views.
...
* [myx](https://github.com/HaseebKhalid1507/Myx) ⭐ 231 | 🐛 9 | 🌐 Rust | 📅 2026-09-09 - Modern Spotify player for the terminal. With reactive themes.
...
* [sparkplayer](https://github.com/dividebysandwich/sparkplayer/tree/main) ⭐ 54 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - A fun terminal based media player with album art and video support.
...
* [MovieBox-TUI](https://github.com/mesamirh/MovieBox-Tui) ⭐ 2,070 | 🐛 10 | 🌐 Rust | 📅 2026-09-18 - Terminal client for discovering and downloading movies and series, with playback in mpv, VLC, or IINA.
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,153 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 - A full-featured EPUB / PDF e-book reader with Vim keybindings.
...
* [managarr](https://github.com/Dark-Alex-17/managarr) ⭐ 771 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - A TUI and CLI for managing Sonarr, Radarr, and other Servarr applications.
...
* [Chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,179 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - Terminal-based Chess game.
...
* [mlbt](https://github.com/mlb-rs/mlbt) ⭐ 164 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 - A tui for the MLB Statcast API. Watch a live game using Gameday, or check scores, standings, and stats.
...
* [tracker](https://github.com/ShenMian/tracker) ⭐ 324 | 🐛 1 | 🌐 Rust | 📅 2026-07-05 - A terminal-based real-time satellite tracking and orbit prediction application.
...
* [tenki](https://github.com/ckaznable/tenki) ⭐ 172 | 🐛 0 | 🌐 Rust | 📅 2026-07-23 - A tty-clock with weather effect.
